...
| Active | M78 data-descriptor sample-member preflight | Reject exact ZIP general-purpose bit 3 before metadata, inventory, staging, or reads while preserving established archive-wide flag precedence; add no raw descriptor parser, broad flag allowlist, workflow, producer, runtime, dependency, or release-authority change |
