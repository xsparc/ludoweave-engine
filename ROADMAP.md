...
| Active | M79 Unicode Path extra-field preflight | Reject exact Info-ZIP extra-field ID `0x7075` before decoded-name policy, metadata, inventory, staging, or reads while preserving established archive-wide precedence; add no broad extra-field ban, workflow, producer, runtime, dependency, or release-authority change |
