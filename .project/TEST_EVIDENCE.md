...
| --- | ---: | --- |
| Primary-source direction scan | Advisory | PKWARE APPNOTE 6.3.10 defines exact extra-field ID `0x0001` as ZIP64 extended information carrying alternate sizes, header offset, and disk-start values. Current CPython substitutes the size and header-offset values when corresponding central-directory fields contain sentinels; its parser does not consume the defined disk-start value. The selected response is exact field-ID preflight, not a broad non-empty-extra rule or raw ZIP64 parser. |
| First installed-Python probe attempt | Invalid setup | Three concurrently started uv processes raced while replacing the shared `.venv`; none reached the stdlib ZIP64 probe. This is not product-test evidence. |
| Corrected sequential CPython 3.12-3.14 ZIP64 probe | 0 | Installed CPython 3.12.13, 3.13.13, and 3.14.5 each applied genuine central-directory ZIP64 values for one 13-byte payload, exposed the 28-byte `0x0001` field, and read the payload. The locked CPython 3.12 graphics environment was restored afterward. |
| Authoritative red regression baseline | 1 | `uv run --frozen pytest -q tests/architecture/test_m80_zip64_extra_field_preflight.py --basetemp=.tmp/m80-baseline` passed 13 standard-library compatibility, established-precedence, unrelated-field, producer, and protected-surface controls while 7 missing early-policy, ordering, cleanup, helper/source, and docs contracts failed in 0.74 seconds. |
| Runtime implementation checkpoint | 1 | The exact constant/helper and separate all-member pass made 19 assertions pass; only the deliberately absent RFC/public-document contract failed in 0.30 seconds. |
| First focused docs checkpoint | Mixed | Format, Ruff, and strict Pyright were clean. Behavioral execution passed 19 controls and failed only because docs split the required exact phrase `no raw ZIP64 parser`; strict docs did not start because the earlier shared-environment race had damaged the local MkDocs installation. Whitespace passed. These failures were corrected rather than treated as passing evidence. |
| Locked MkDocs repair | 0 | The sandboxed `uv sync --frozen --all-groups --extra graphics --python 3.12 --reinstall-package mkdocs` first failed with shared-cache access denied. The approved retry reinstalled locked MkDocs 1.6.1 successfully; this was environment repair, not a product gate. |
| Focused implementation/static/docs gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings; all 20 M80 assertions passed in 0.26 seconds. Strict docs built in 1.31 seconds with only the known upstream Material notice; whitespace passed. |
| First whole-tree invocation inside the managed sandbox | Invalid setup | Every uv segment failed before validation because the sandbox could not open uv's shared user cache. The whitespace segment produced no error. No product-gate result is claimed. |
| Lock, whole-tree static, architecture, and docs gate | 0 | The approved retry resolved the unchanged 46-package lock in 0.92 ms and checked the restored 45-package graphics environment. All 323 files were format clean; Ruff and strict Pyright reported zero findings; all 894 architecture tests passed with 1 capability skip in 6.53 seconds; strict docs built in 1.27 seconds with only the known upstream Material notice; whitespace passed. |
| Exact M64-M80 release-consumer lineage | 0 | All 205 bounded-container, policy-ordering, ownership, inventory, staging, parser-normalization, and exact ZIP64 assertions passed with 1 Windows capability skip in 1.66 seconds. |
| Complete supported-Python suites | 0 | CPython 3.12.13 passed 2,424 non-wgpu tests with 15 capability skips in 102.81 seconds. CPython 3.13.13 passed 2,424 tests with 16 skips in 99.55 seconds; CPython 3.14.5 passed 2,424 with 16 skips in 107.74 seconds. The locked CPython 3.12 graphics environment was restored afterward with 45 packages. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.47 seconds. One-repeat base and graphics profiles validated with 2 and 3 workloads. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
...
| Reproducible distribution and release gate | 0 | Two fresh builds reproduced a pure 274,845-byte wheel at `018f4cb0bc3d231a3fdd3479027bb7e0a483851516273f7a7609ed610edb3c84` and a 1,295,107-byte sdist at `557235f0735245ebf82b7945ca77c7e183fb34af2237e613e0428ce9b8140de8`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| Findings-first review | Clean | Exact field-ID policy, bounded field walk, separate all-member ordering, established M69/M75/M76/M78/M79 precedence, M77 precedence, stable content-silent error, owned cleanup, producer compatibility, and protected surfaces are sound. Unrelated field IDs and incomplete trailing bytes remain accepted by the private helper; malformed declared fields remain CPython parser policy before preflight. No actionable finding was identified. |
| Exact scope, protected-surface, disclosure, credential, and archive audit | Clean | Exactly 16 intended paths change. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. Explicit development-tool identity and credential/private-key scans found no added marker. The 94-entry wheel and 526-entry sdist contain no native, WASM, bytecode, or retired control metadata. |
| First record-inclusive source/repository gate | 0 | The unchanged lock resolved 46 packages in 0.77 ms; all 323 files were format clean; Ruff and strict Pyright reported zero findings; all 894 architecture tests passed with 1 capability skip in 6.09 seconds; strict docs built in 1.25 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Exact prepublication history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and merge base all resolve to exact M79 closeout `892f17fce99d218905c6f624c730f735d21a794f`; symmetric difference is `0 0` and history is linear. Only `origin/main` exists remotely; GitHub reports no open PR, tag, or release. |
| Initial exact-head hosted qualification | Corrected | Ready PR #192 qualified exact DCO head `30793a758fc57b8a23d92b84cd911c5b979f977d` in successful run `31711574308`. Linux job `94485652885` passed in 7m23s, macOS `94488092155` in 2m53s, and Windows `94488092105` in 4m08s. Linux CPython 3.12 passed 2,439 tests; Linux 3.13/3.14 and both desktop 3.14 suites passed 2,439 with 1 capability skip. Every OS passed 10 real-wgpu tests, profiles, and both vertical slices; static/docs, installed-wheel, deterministic staging, and release smoke passed. Hosted reproducibility reported a 274,831-byte wheel at `149e02344b1ca8fc779f7c7e410a6f497c99da4d372ae4b76e70865a6eac9255` and 1,296,111-byte sdist at `4e76b83341676db0b2d9f2a313f4a898f96937be948a83f6aef764b51d663002`. Review then found the documentation defect below, so this head is not mergeable evidence. |
| Hosted disk-start wording review | Corrected | Review correctly identified that RFC/project wording blurred PKWARE's defined 32-bit disk-start capacity with CPython's actual parser behavior. Supported CPython applies only uncompressed size, compressed size, and local-header offset from `0x0001`; the genuine fixture likewise contains and establishes only those three 64-bit values. The corrected records distinguish specified capacity from observed parser behavior. Runtime code and its policy are unchanged. |
| Review-correction local gate | 0 | The strengthened docs regression requires the RFC to distinguish the defined disk-start field from CPython's behavior and fixture evidence. The test remained format/Ruff clean and strict Pyright reported zero findings; all 20 M80 assertions passed in 0.26 seconds, all 894 architecture tests passed with 1 capability skip in 6.53 seconds, strict docs built in 1.24 seconds with only the known upstream notice, and whitespace passed. |
| Final record-inclusive correction gate | 0 | The unchanged lock resolved 46 packages in 0.75 ms; all 323 files were format clean; Ruff and strict Pyright reported zero findings; all 894 architecture tests passed with 1 capability skip in 6.14 seconds; strict docs built in 1.24 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |

## M80 corrected hosted validation and feature integration - 2026-08-14

| Command or review | Exit | Result |
| --- | ---: | --- |
| Corrected exact-head hosted qualification | 0 | Ready PR #192 qualified exact DCO head `0a42620d3771bde90978a697b672d51bf66273a5`, tree `c7703140e53afe5cdd8a7cf61ee7e97b71737a60`, in successful run `31713078940`. Linux job `94490785476` passed in 7m24s, macOS `94493098093` in 2m42s, and Windows `94493098213` in 4m28s. Linux CPython 3.12 passed 2,439 tests; Linux 3.13/3.14 and both desktop 3.14 suites passed 2,439 with 1 capability skip. Every OS passed 10 real-wgpu tests, profiles, and both vertical slices; static/docs, installed-wheel, deterministic staging, and complete release smoke passed. |
| Corrected hosted artifact identity | 0 | Same-head reproducibility produced a pure 274,831-byte wheel at `149e02344b1ca8fc779f7c7e410a6f497c99da4d372ae4b76e70865a6eac9255` and a 1,297,189-byte sdist at `0bea646a029b214de2152cbddba6c4353a63be6a24bb1d82c1b55314bcc2f3d7`. |
| Corrected review audits | Clean | The first corrected-head audit found exact base/head, three successful checks, no issue comment or new review finding, and the original addressed thread outdated but unresolved. A concise response identified correction `0a42620`; the thread was resolved. The second separated audit retained exact base/head and `MERGEABLE`/`CLEAN`, with one resolved outdated thread containing the original finding and maintainer response, no issue comments, and no new finding. Both feature commits carry standalone DCO sign-off. |
| Guarded squash integration audit | 0 | Exact-head-guarded squash merged PR #192 at `13439d41551cd9c842b3e7a0a55e7ba72e540582`. Its tree `c7703140e53afe5cdd8a7cf61ee7e97b71737a60` exactly equals the corrected qualified head, its sole parent is M79 closeout `892f17fce99d218905c6f624c730f735d21a794f`, its body carries standalone DCO, and GitHub verification is valid at `2026-08-13T15:14:33Z`. No post-merge `main` run was allocated. The remote feature branch was deleted; after exact-tree verification, the squash-only local feature branch was deleted. Only synchronized `main` plus the intended integration-record branch remain locally, and only `origin/main` remains remotely. No tag, release, or publication exists. |

## M80 integration-record local evidence - 2026-08-14, Windows, CPython 3.12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Exact four-file source/repository gate | 0 | From exact feature squash `13439d41551cd9c842b3e7a0a55e7ba72e540582`, the unchanged 46-package lock resolved in 0.83 ms and the 45-package graphics environment checked. All 323 files were format clean; Ruff and strict Pyright reported zero findings; all 894 architecture tests passed with 1 capability skip in 6.56 seconds; strict docs built in 1.28 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Integration-record reproducibility and release gate | 0 | Two fresh builds reproduced a pure 274,845-byte wheel at `018f4cb0bc3d231a3fdd3479027bb7e0a483851516273f7a7609ed610edb3c84` and a 1,298,516-byte sdist at `ba5af9cde94f2cff5a619e31afd4550b4e9d1074ea16a2d91923dee60280c53c`. Byte comparison, isolated-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this row changes the sdist, so hosted integration-head identities remain authoritative. |
...
`1e1da7d8062433c2297d170643626413dfbd457f`. The worktree was clean; only
`main` existed locally/remotely and GitHub reported no open PR, tag, or release
before the neutral feature branch was created.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Primary-source direction scan | Advisory | Current PKWARE APPNOTE defines Info-ZIP Unicode Path extra-field ID `0x7075`. Current CPython walks central-directory extra fields and, for valid version/CRC, replaces `ZipInfo.filename` with its UTF-8 path while retaining the legacy `orig_filename`. The selected response is exact field-ID preflight, not a broad non-empty-extra or name-difference rule. |
| Installed CPython 3.12-3.14 Unicode Path probe | 0 | CPython 3.12.13, 3.13.13, and 3.14.5 each exposed replacement `ludoweave-samples-0.1.0a1/README.md`, retained legacy `ludoweave-samples-0.1.0a1/legacy.txt`, and read `unicode path payload` from the same genuine archive. The locked CPython 3.12 graphics environment was restored with 45 packages. A fixed-producer probe confirmed all 50 members have empty extra fields. |
| First regression invocation before test cleanup | Invalid baseline | Behavioral execution produced the intended 7 missing-policy/source/docs failures and 11 passing controls, but Ruff format reported one required reformat and strict Pyright reported one unused test helper. It is not the authoritative red baseline. |
| Corrected red regression baseline | 1 | The test-only correction is format/Ruff clean and strict Pyright reports zero findings. Against unchanged M78, 11 standard-library compatibility, established-precedence, unrelated-field, producer, and protected-surface assertions passed while 7 early-policy, ordering, cleanup, helper/source, and RFC/docs contracts failed in 0.37 seconds. |
| Runtime implementation checkpoint | 1 | One exact private constant/helper and one separate all-member pass made 17 assertions pass in 0.31 seconds; only the deliberately absent RFC/public-document contract failed. |
| Focused implementation/static/docs gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings; all 18 M79 assertions passed in 0.24 seconds. Strict docs built in 1.22 seconds with only the known upstream notice; whitespace passed. |
| Lock, whole-tree static, extraction-lineage, architecture, and docs gate | 0 | The unchanged lock resolved 46 packages in 0.83 ms. All 322 files were format clean; Ruff and strict Pyright reported zero findings. The exact M64-M79 lineage passed 185 assertions with 1 capability skip in 1.57 seconds; all 874 architecture assertions passed with 1 skip in 7.04 seconds; strict docs built in 1.66 seconds with only the known upstream notice; whitespace passed. |
| Complete supported-Python suites | 0 | CPython 3.12.13 passed 2,404 non-wgpu tests with 15 capability skips in 107.45 seconds. CPython 3.13.13 passed 2,404 tests with 16 skips in 99.38 seconds; CPython 3.14.5 passed 2,404 with 16 skips in 106.29 seconds. The locked CPython 3.12 graphics environment was restored afterward with 45 packages. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.51 seconds. One-repeat base and graphics profiles validated with 2 and 3 workloads. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| M1-M4 diagnostic validation | 0 | M1 validated 7 workloads and observed 1 of 2 targets; M2 validated 4 informational workloads with no targets; M3 validated 6 workloads and met 0 of 2 current targets; M4 validated 3 workloads and observed its baseline target. These dirty-tree timing observations are diagnostic and make no new performance claim. |
| Reproducible distribution and release gate | 0 | Two builds reproduced a pure 274,734-byte wheel at `014e443b6bc0094c74521ba3211940cfc8db7c8c932212d4c1eea742a5c3f566` and a 1,287,732-byte sdist at `fadce6c20313cb04ae83e71195b8fd7713e338e8c99b570473cc70635d2d226a`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. The unchanged 111,168-byte sample remains `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`. |
| Findings-first review | Clean | Exact field-ID policy, bounded field walk, separate all-member ordering, established M69/M75/M76/M78 precedence, M77 precedence, stable content-silent error, owned cleanup, producer compatibility, and protected surfaces are sound. Unrelated field IDs and incomplete trailing bytes remain accepted by the private helper; malformed declared fields remain CPython parser policy before preflight. No actionable finding was identified. |
| Exact scope, protected-surface, disclosure, credential, and archive audit | Clean | Exactly 16 intended paths change. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. Explicit development-tool identity and credential/private-key scans returned zero matches. The 94-entry wheel and 524-entry sdist contain no native, WASM, bytecode, or retired control metadata. |
| Exact prepublication history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and merge base all resolve to exact M78 closeout `5fe3134bf5a56e5cbf986ed33db698c830aa9219`; symmetric difference is `0 0` and history is linear. Only `origin/main` exists remotely; GitHub reports no open PR, tag, or release. |
| Record-inclusive frozen lock/static/architecture/docs gate | 0 | The unchanged lock resolved 46 packages in 0.75 ms. All 322 files were format clean; Ruff and strict Pyright reported zero findings; all 874 architecture assertions passed with 1 capability skip in 6.03 seconds; strict docs built in 1.19 seconds with only the known upstream notice. Whitespace and full Git-object checking passed with expected unreachable development objects only. |
...
## M79 hosted integration-record evidence - 2026-08-14

| Command or review | Exit | Result |
| --- | ---: | --- |
| Hosted integration-record qualification | 0 | Exact DCO head `31169c0b90bea95277397e86f40a33f5fcd22287`, tree `761c2a6007ad8f3be340a0f6796ffe5983ea06a5`, passed run `31708261506`. The trusted classifier identified exactly four changed paths as documentation. Linux job `94474232250` passed in 47 seconds; desktop umbrella `94474491443` skipped with zero steps. |
| Hosted documentation/artifact gate | 0 | All 322 files were format clean; Ruff passed; strict docs built in 1.75 seconds; all 875 hosted architecture assertions passed in 10.27 seconds. Two builds reproduced a pure 274,721-byte wheel at `3a3785fd9da167d4ad966dd51cae0293d10cd3e9d1da870a414f750c52d42898` and a 1,289,953-byte sdist at `dccb332e1e2faebe6c738a493deac55db3a1b13e7f1a1aac144e21fecf65545e`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| Two separated integration review-state audits | Clean | GitHub reported zero conversation comments, reviews, inline comments, and review threads in both audits. PR #190 remained ready, clean, mergeable, exact-head, exact-base, and successful with only the expected skipped desktop umbrella. |
| Verified integration-record squash | Clean | PR #190 merged at `2026-08-13T14:07:28Z` as `2de20b719d0c79d87187fea95b8a58f31491dad4`. Its tree exactly equals reviewed tree `761c2a6007ad8f3be340a0f6796ffe5983ea06a5`; its sole parent is feature squash `9bc8e3813a9e25bbb977d74201fceeed3db31be2`; the DCO trailer and identity are exact; GitHub verification is valid at `2026-08-13T14:07:36Z`. The obsolete integration branch was deleted locally and remotely. |

## M79 closeout local evidence - 2026-08-14, Windows, CPython 3.12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Exact three-record closeout gate | 0 | Exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, and `.project/TEST_EVIDENCE.md` changed. The unchanged lock resolved 46 packages in 0.80 ms; all 322 files were format clean; Ruff and strict Pyright reported zero findings; all 874 architecture assertions passed with 1 capability skip in 6.14 seconds; strict docs built in 1.26 seconds with only the known upstream notice. Whitespace, exact base/HEAD history `0 0`, and full Git-object checking passed with expected unreachable development objects only. |
| Closeout post-record gate | 0 | The unchanged lock resolved 46 packages in 0.84 ms; all 322 files were format clean; Ruff and strict Pyright reported zero findings; all 874 architecture assertions passed with 1 capability skip in 6.02 seconds; strict docs built in 1.22 seconds with only the known upstream notice. Whitespace and exact three-path scope passed. |
...
`a47d36363bdc48a91ef55feae8e8f3b53077907a`. The worktree was clean and only
the neutral feature branch plus `main` existed locally; only `origin/main`
existed remotely.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Primary-source direction scan | Advisory | Current PKWARE APPNOTE assigns general-purpose bit 3 to data descriptors, where local-header CRC-32 and sizes are deferred to a record after member data. Current CPython defines the same mask and supports the representation. The selected response is exact private bit-3 preflight, not a raw descriptor parser or broad flag allowlist. |
| Installed CPython 3.12-3.14 descriptor probe | 0 | CPython 3.12.13, 3.13.13, and 3.14.5 each produced a genuine descriptor-signature member with bit 3 set when writing to an unseekable stream and read its payload. The equivalent fixed seekable producer shape emitted bit 3 clear. |
| `uv run --frozen pytest -q tests/architecture/test_m78_data_descriptor_member_preflight.py --basetemp=.tmp/m78-baseline` | 1 | Against unchanged M77, 9 compatibility, established-precedence, producer, and protected-surface assertions passed while 7 early-policy, cross-member ordering, cleanup, helper/source, and RFC/docs contracts failed in 0.37 seconds. The new test was format/Ruff clean and strict Pyright reported zero findings. |
| Runtime implementation checkpoint | 1 | One exact private constant/helper and one separate all-member pass made 15 assertions pass in 0.30 seconds; only the deliberately absent RFC/public-document contract failed. |
| Focused implementation/static/docs gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings; all 16 M78 assertions passed in 0.23 seconds. Strict docs built in 1.20 seconds with only the known upstream notice; whitespace passed. |
| First whole-tree gate in managed sandbox | Invalid setup | The existing user-level uv cache denied sandbox access before any lock, static, test, or docs segment ran. No project result was produced; the identical managed-cache rerun below is authoritative. |
| Lock, whole-tree static, extraction-lineage, architecture, and docs gate | 0 | The unchanged lock resolved 46 packages in 0.83 ms and the CPython 3.12 graphics environment restored 45 packages. All 321 files were format clean; Ruff and strict Pyright reported zero findings. The exact M64-M78 lineage passed 167 assertions with 1 capability skip in 1.51 seconds; all 856 architecture assertions passed with 1 skip in 6.35 seconds; strict docs built in 1.17 seconds with only the known upstream notice; whitespace passed. |
| Complete supported-Python suites | 0 | CPython 3.12.13 passed 2,386 non-wgpu tests with 15 capability skips in 106.25 seconds. CPython 3.13.13 passed 2,386 tests with 16 skips in 100.83 seconds; CPython 3.14.5 passed 2,386 with 16 skips in 107.24 seconds. The locked CPython 3.12 graphics environment was restored afterward with 45 compatible packages. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.67 seconds. One-repeat base and graphics profiles validated with 2 and 3 workloads. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| M1-M4 diagnostic validation | 0 | M1 validated 7 workloads and observed 1 of 2 targets; M2 validated 4 informational workloads with no targets; M3 validated 6 workloads and met 0 of 2 current targets; M4 validated 3 workloads and observed its baseline target. These dirty-tree timing observations are diagnostic and make no new performance claim. |
| Reproducible distribution and release gate | 0 | Two builds reproduced a pure 274,573-byte wheel at `dcf1cce4641069365c6e572f5189aee237ba2b7ff7f9e3fde17cf89ecdbbab68` and a 1,280,223-byte sdist at `5c9e860c7790f60af40f5155b2b2626149e688b9cd5ceed53caf65997bff7d18`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. The unchanged 111,168-byte sample is `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`. |
| Findings-first review | Corrected | Runtime policy, separate all-member ordering, established M69/M75/M76 precedence, M77 precedence, stable content-silent error, owned cleanup, and protected surfaces are sound. Review removed one producer assertion that searched raw archive bytes for the optional descriptor signature because ordinary compressed payload bytes can match it; the canonical per-member bit-3 guard remains. No runtime behavior or intended scope changed. |
| Review-corrected static, focused, architecture, docs, and whitespace gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings; all 16 M78 assertions passed in 0.26 seconds; all 856 architecture assertions passed with 1 capability skip in 6.19 seconds; strict docs built in 1.19 seconds with only the known upstream notice; whitespace passed. |
| Exact scope, protected-surface, disclosure, credential, and archive audit | Clean | Exactly 16 intended paths change. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. The explicit development-tool identity scan returned zero matches. The credential scan matched only historical literal negative-test URI `?token=[bad]`, not secret material. The 94-entry wheel and 522-entry sdist contain no native, WASM, bytecode, or retired control metadata. |
| Exact prepublication history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and merge base all resolve to exact M77 closeout `4bca618578f29629a7270ab5d9d308fd34363a06`; symmetric difference is `0 0` and history is linear. Only `origin/main` exists remotely; GitHub reports no open PR, tag, or release. Full Git-object checking reports only expected unreachable development objects. |
| Record-inclusive frozen lock/static/architecture/docs gate | 0 | The unchanged lock resolved 46 packages in 0.77 ms. All 321 files were format clean; Ruff and strict Pyright reported zero findings; all 856 architecture assertions passed with 1 capability skip in 6.12 seconds; strict docs built in 1.20 seconds with only the known upstream notice. Whitespace and full Git-object checking passed, with only expected unreachable development objects reported. |
...
## M78 hosted integration-record evidence - 2026-08-13

| Command or review | Exit | Result |
| --- | ---: | --- |
| Hosted integration-record qualification | 0 | Exact DCO head `a542979555916edc1fb585bbe64eb9116c8beb85`, tree `c807cd3f72edc81c37597ec3744661bafd41d36f`, passed run `31703080076`. The trusted classifier identified exactly four changed paths as documentation. Linux job `94456747258` passed in 44 seconds; desktop umbrella `94456961672` skipped with zero steps. |
| Hosted documentation/artifact gate | 0 | All 321 files were format clean; Ruff passed; strict docs built in 1.63 seconds; all 857 hosted architecture assertions passed in 9.96 seconds. Two builds reproduced a pure 274,559-byte wheel at `ccbe8d92ed51ac31c4fc0e0ca1e52fbf697d20e4b7dc9250a15ad718944a8b5b` and a 1,282,392-byte sdist at `c3f58daeb5d7a4c307149b22358402abab390b738f33011453c335347a880e93`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| Two separated integration review-state audits | Clean | GitHub reported zero conversation comments, reviews, inline comments, and review threads in both audits. PR #187 remained ready, clean, mergeable, exact-head, exact-base, and successful with only the expected skipped desktop umbrella. |
| Verified integration-record squash | Clean | PR #187 merged at `2026-08-13T13:06:39Z` as `905d40a8091dd6b4e5cf8e4e72d8c7873b7aadb9`. Its tree exactly equals reviewed tree `c807cd3f72edc81c37597ec3744661bafd41d36f`; its sole parent is feature squash `180d93dbe6984fff43af07021efd000150b76132`; the DCO trailer and identity are exact; GitHub verification is valid at `2026-08-13T13:06:46Z`. The obsolete integration branch was deleted locally and remotely. |

## M78 closeout local evidence - 2026-08-13, Windows, CPython 3.12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Exact three-record closeout gate | 0 | Exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, and `.project/TEST_EVIDENCE.md` changed. The unchanged lock resolved 46 packages in 0.96 ms; all 321 files were format clean; Ruff and strict Pyright reported zero findings; all 856 architecture assertions passed with 1 capability skip in 6.36 seconds; strict docs built in 1.22 seconds with only the known upstream notice. Whitespace and full Git-object checking passed with expected unreachable development objects only. |
| Closeout post-record gate | 0 | All 321 files were format clean; Ruff and strict Pyright reported zero findings; all 856 architecture assertions passed with 1 capability skip in 6.28 seconds; strict docs built in 1.16 seconds with only the known upstream notice. Whitespace and exact three-path scope passed. |
...
`27cfc273accb3190d0c50e6a344685875cce541b`. The worktree was clean; only
`main` existed locally and remotely; no PR, tag, or release was open or
published before the neutral feature branch was created.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Primary-source direction scan | Advisory | Current CPython source assigns the decoded central-directory filename used to construct `ZipInfo` to `orig_filename`, then truncates normalized `filename` at the first NUL. Current Python 3.14 documentation explicitly documents archive-name truncation at a null byte. The selected response is one exact NUL check on `orig_filename`, not a general original-versus-normalized comparison or raw parser. |
| Installed CPython 3.12-3.14 runtime probe | 0 | CPython 3.12.13, 3.13.13, and 3.14.5 each read an in-memory member stored as `root/README.md\0hidden`, exposed that complete `orig_filename`, exposed truncated `filename` value `root/README.md`, and returned the payload. The locked CPython 3.12 documentation environment was restored afterward with 39 packages. |
| `uv run --frozen pytest -q tests/architecture/test_m77_nul_member_name_preflight.py --basetemp .tmp/m77-baseline` | 1 | Against unchanged M76, 6 standard-library, existing-precedence, producer, and protected-surface assertions passed while 6 early-policy, later-member ordering, cleanup, helper/source, and RFC/docs contracts failed in 0.91 seconds. The exact visible inventory with a hidden NUL suffix reached inventory/staging/extraction; the private validator and M77 records were absent. The new test was format/Ruff clean and strict Pyright reported zero findings. |
| First inherited runtime-checkpoint command with stale filename | Invalid setup | The command named nonexistent `test_m69_encrypted_member_preflight.py`, so pytest collected no tests. The affected implementation/test files were nevertheless format/Ruff/Pyright clean; the corrected command below supplies the behavioral evidence. |
| Corrected runtime implementation checkpoint | 1 | The exact M69/M75/M76/M77 group passed 40 assertions in 0.53 seconds; only the deliberately absent M77 RFC/public-document assertion failed. One private helper now performs the exact NUL check after all established flag validators. |
| Focused implementation/static/docs gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings; all 12 M77 assertions passed in 0.89 seconds. Strict docs built in 1.70 seconds with only the known upstream notice; whitespace passed. |
| Inherited M64-M77 extraction-lineage gate | 0 | The exact 14 current extraction/security test files passed 148 assertions with 1 local filesystem-capability skip in 1.68 seconds. |
| Lock, graphics environment, whole-tree static, and docs gate | 0 | The unchanged lock resolved 46 packages in 1 ms and the restored CPython 3.12 graphics environment installed 45 compatible packages. All 320 files were format clean; Ruff and strict Pyright reported zero findings; strict docs built in 2.06 seconds with only the known upstream notice; whitespace passed. |
| Complete CPython 3.12 gate | 0 | CPython 3.12.13 passed 2,367 non-wgpu tests with 15 skips in 136.68 seconds. |
| Architecture and supported-Python gate | 0 | All 837 architecture assertions passed with 1 local capability skip in 8.25 seconds. CPython 3.13.13 passed 2,367 tests with 15 skips in 128.69 seconds; CPython 3.14.5 passed 2,367 with 15 skips in 126.57 seconds. The locked CPython 3.12 graphics environment was restored afterward with 45 compatible packages. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 9.44 seconds. Five-repeat base and graphics profiles validated. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| First M1-M4 validator chain | 1 | M1 validated 7 workloads and observed 1 of 2 targets; M2 validated 4 informational workloads with no targets; M3 validated 6 workloads and met 0 of 2 current targets. M4 produced its complete artifact, but module-mode invocation of its validator failed because that file imports its sibling as a direct script. This is invocation/setup evidence, not a product result. |
| Corrected M4 diagnostic validation | 0 | Direct-script invocation validated all 3 M4 workloads and observed the baseline target. Together, all four dirty-tree diagnostic artifacts validate; these timing observations remain diagnostic rather than release gates. |
| Pre-review reproducible distribution and release gate | 0 | Two builds reproduced a pure 274,448-byte wheel at `ecf37cf1a420433cdc0b5a3ff07fefff5450e5d7ae0b6cdff1e2d3e88639dea9` and a 1,272,210-byte source distribution at `932b43823605e870598b08f0b54c98fd1bc491a38769e2440ea1aec8ab094892`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. The unchanged sample is 111,168 bytes/50 entries at `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`; the wheel has 94 entries, the sdist 520, and no inspected archive entry is native, WASM, bytecode, or retired control metadata. One sandboxed archive-count inspection encountered a uv-cache access denial; the corrected managed-cache inspection supplied these counts. |
| Findings-first review | Corrected | The exact NUL check, stable content-silent error, all-member ordering, owned cleanup, established flag precedence, producer compatibility, and protected surfaces are sound. Review found that public wording could imply `orig_filename` universally records every later normalized-name source. The corrected contract identifies it specifically as the decoded central-directory filename used to construct `ZipInfo`; Unicode Path extra-field substitution, arbitrary normalized-name differences, and raw header consistency remain outside scope. |
| Review-corrected static, focused, architecture, docs, and whitespace gate | 0 | All 320 files were format clean; Ruff and strict Pyright reported zero findings; all 12 M77 assertions passed in 0.27 seconds; all 837 architecture assertions passed with 1 local capability skip in 8.12 seconds; strict docs built in 1.33 seconds with only the known upstream notice; whitespace passed. |
| Record-inclusive reproducibility and release gate | 0 | Two builds reproduced a pure 274,448-byte wheel at `ecf37cf1a420433cdc0b5a3ff07fefff5450e5d7ae0b6cdff1e2d3e88639dea9` and a 1,273,541-byte record-updated source distribution at `11f7a22829654db4dd855bf771bfd8d8cf391136872b7152d1ff5a817ddd765f`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this result changes the source archive; exact commit-tree artifact identity remains delegated to hosted qualification. |
| Final frozen lock/static/architecture/docs/Git gate | 0 | The unchanged lock resolved 46 packages in 0.93 ms; all 320 files were format clean; Ruff and strict Pyright reported zero findings; all 837 architecture assertions passed with 1 local capability skip in 8.31 seconds; strict docs built in 1.39 seconds with only the known upstream notice. Whitespace and full Git-object checking passed, with only expected unreachable development objects reported. |
| Exact scope, protected-surface, disclosure, credential, and archive audit | Clean | Exactly 16 intended paths change. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. The explicit development-tool identity and corrected credential/private-key scans returned zero matches. One initially broad identity scan found only Apache-2.0's unrelated phrase `display generated by`; two first credential-scan forms had option-order errors before the corrected scan. The 94-entry wheel and 520-entry sdist contain no native, WASM, bytecode, or retired control metadata. |
| Exact prepublication history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and merge base all resolve to exact M76 closeout `701637f99447f4d64c84047e64ec5edfa0c6889f`; symmetric difference is `0 0` and history is linear. Only `origin/main` exists remotely; GitHub reports no open PR, tag, or release. |
| Evidence-inclusive post-record gate | 0 | The unchanged lock resolved 46 packages in 1 ms; all 320 files were format clean; Ruff and strict Pyright reported zero findings; all 837 architecture assertions passed with 1 local capability skip in 24.90 seconds; strict docs built in 1.72 seconds with only the known upstream notice. Whitespace and exact 16-path scope passed. |
| First exact-head hosted qualification | 0 | Ready PR #183 qualified exact DCO head `bd338004fc44d441b7190223645a8ad9802b7819` in successful run `31695444362`. Linux job `94432064196` passed first in 7m18s; guarded macOS job `94433768246` then passed in 2m08s and Windows job `94433768098` in 4m09s. Linux CPython 3.12/3.13/3.14 passed 2,382 tests in 132.19/109.58/113.17 seconds, with one skip on 3.13 and 3.14. macOS and Windows 3.14 each passed 2,382 with one skip in 87.10 and 190.52 seconds. All 320 files were format clean; Ruff, strict Pyright, strict docs, 10 real-wgpu tests per OS, profiles, vertical slices, wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| First hosted artifact identity | 0 | Exact first-head qualification reproduced a pure 274,436-byte wheel at `ed5d57f1229e46e49f90ed306b78b2ce52d0a3f25a815e7c695de04ea19cba53` and a 1,274,371-byte sdist at `74149713a27bc9f5f08e9899707f13e908bfc38f4a19d27bd701802352383260`. Hosted deterministic state/replay contracts passed; platform-specific capture hashes are not claimed identical. |
| First hosted review audit | Corrected | The audit found one P2 archive-wide precedence defect: an earlier NUL-suffixed member could fail before the per-member loop reached a later encrypted, compressed-patched, or enhanced-deflated member. Complete release smoke now completes the established all-member flag pass before a separate all-member name pass. Three cross-member regressions cover all established flag categories. |
| Corrected focused implementation gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings; all 15 corrected M77 assertions passed in 0.40 seconds; strict docs built in 1.50 seconds with only the known upstream notice; whitespace passed. The exact 16-path milestone scope is unchanged. |
| Corrected whole-tree static/architecture/docs gate | 0 | After one expected sandbox uv-cache denial, the managed-cache rerun resolved the unchanged 46-package lock in 1 ms. All 320 files were format clean; Ruff and strict Pyright reported zero findings; all 840 architecture assertions passed with 1 local capability skip in 7.63 seconds; strict docs built in 1.41 seconds with only the known upstream notice. Whitespace and exact 16-path scope passed. |
| Corrected supported-Python suites | 0 | CPython 3.12.13 passed 2,380 tests with 15 local capability skips in 119.91 seconds. CPython 3.13.13 passed 2,370 with 16 skips in 116.78 seconds; CPython 3.14.5 passed 2,370 with 16 skips in 108.45 seconds. The locked CPython 3.12 graphics environment was restored afterward with 45 compatible packages. |
| Corrected graphics, profile, and vertical-slice gate | 0 | All 10 real-wgpu tests passed in 7.82 seconds. One-repeat base and graphics profiles validated with 2 and 3 workloads. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| Corrected reproducible distribution and release gate | 0 | Two fresh builds reproduced a pure 274,448-byte wheel at `ecf37cf1a420433cdc0b5a3ff07fefff5450e5d7ae0b6cdff1e2d3e88639dea9` and a 1,275,626-byte sdist at `0e7e002224fb53ec4d26845dac03ba9f3ecf6dfba36993273e58ee49e8d9334b`. Byte comparison, isolated-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Exact commit-tree artifact identity remains delegated to corrected-head hosted qualification because recording this evidence changes the sdist. |

## M77 hosted validation and feature integration - 2026-08-13

| Command or review | Exit | Result |
| --- | ---: | --- |
| First exact-head hosted run | 0 | Exact DCO head `bd338004fc44d441b7190223645a8ad9802b7819` passed run `31695444362`: Linux `94432064196` in 7m18s, macOS `94433768246` in 2m08s, and Windows `94433768098` in 4m09s. Each hosted suite passed 2,382 tests; compatibility suites recorded one capability skip. |
| Hosted review correction | Corrected | The first complete audit found one P2: an earlier NUL-suffixed member masked a prohibited flag on a later member. DCO correction `482aa76c68c1ab3d17f22f4fa1d286c7ab03ed9a` moved name validation to a separate archive-wide pass after every member's established flag checks and added three cross-member M69/M75/M76 regressions. |
| Corrected exact-head hosted run | 0 | Run `31697316773` qualified exact correction head. Linux job `94437954084` passed in 7m33s; only then did macOS `94439748828` pass in 3m07s and Windows `94439748832` in 3m57s. Linux CPython 3.12/3.13/3.14 passed 2,385 tests in 136.44/112.48/115.57 seconds, with one skip on 3.13/3.14. macOS and Windows 3.14 passed 2,385 with one skip in 136.45 and 187.94 seconds. All 320 files were format clean; Ruff, strict Pyright, strict docs, 10 real-wgpu tests per OS, profiles, vertical slices, installed-wheel smoke, deterministic staging, and complete release smoke passed. |
| Corrected hosted artifact identity | 0 | Two hosted builds reproduced a pure 274,436-byte wheel at `ed5d57f1229e46e49f90ed306b78b2ce52d0a3f25a815e7c695de04ea19cba53` and a 1,275,988-byte sdist at `b78b629377d1c57c81b799081500ffa0b3db88e47910b0bf7caf2bfabfb9c5b1`. All ten staged artifacts validated. Deterministic state/replay identities passed; platform-specific captures are not claimed identical. |
| Two separated post-correction audits | Addressed finding retained | Both audits found zero conversation comments and no new review or inline comment. The original P2 thread remains unresolved because no GitHub thread-resolution write was authorized. Its requested two-pass correction and three cross-member regressions are present on the exact qualified head; the PR remained ready, `CLEAN`, `MERGEABLE`, exact-head, and exact-base with all checks green. |
| Feature squash integration verification | Qualified with process note | PR #183 merged at `2026-08-13T12:04:10Z` as `0c3c407c1e5d86541570c665fd305fa95e32e07a`. The squash tree exactly equals qualified feature tree `923efabb7b6968a53db2035c107baa80b89119cc`; its sole parent is M76 closeout `701637f99447f4d64c84047e64ec5edfa0c6889f`; author identity is `Louijie Compo <louijie.compo@gmail.com>`; GitHub verification is valid at `2026-08-13T12:04:14Z`. Both source commits contain parseable DCO trailers. The squash body contains literal `\n\n` characters before identical sign-off text, so the squash message itself has no parseable trailer; this process defect is explicitly retained and no history rewrite is made. The obsolete feature branch was deleted locally and remotely. |

## M77 integration-record local evidence - 2026-08-13, Windows, CPython 3.12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Four-file integration-record local gate | 0 | Exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, `.project/TEST_EVIDENCE.md`, and `ROADMAP.md` changed. The unchanged lock resolved 46 packages in 0.97 ms. All 320 files were format clean; Ruff and strict Pyright reported zero findings; all 840 architecture assertions passed with 1 local capability skip in 8.08 seconds; strict docs built in 1.42 seconds with only the known upstream notice. Whitespace and full Git-object checking passed. |
| Integration-record reproducibility and release gate | 0 | Two fresh builds reproduced a pure 274,448-byte wheel at `ecf37cf1a420433cdc0b5a3ff07fefff5450e5d7ae0b6cdff1e2d3e88639dea9` and a 1,276,069-byte sdist at `b3c006291029b277b9d2db49d5e2ec01aea59b81f7d0dff1e933548352741f6d`. Byte comparison, isolated-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this row changes the sdist, so hosted integration-head identities remain authoritative. |

## M77 hosted integration-record evidence - 2026-08-13

| Command or review | Exit | Result |
| --- | ---: | --- |
| Hosted integration-record qualification | 0 | Exact DCO head `ed1eb024cc4098d03a02c06c5c5dda6e3df8792a`, tree `baffa85b731086ba71a247411cfbca51c4bdbc72`, passed run `31698788838`. The trusted classifier identified exactly four changed paths as documentation. Linux job `94442610271` passed in 47 seconds; desktop umbrella `94442838671` skipped with zero steps. |
| Hosted documentation/artifact gate | 0 | All 320 files were format clean; Ruff passed; strict docs built in 1.80 seconds; all 841 hosted architecture assertions passed in 10.60 seconds. Two builds reproduced a pure 274,436-byte wheel at `ed5d57f1229e46e49f90ed306b78b2ce52d0a3f25a815e7c695de04ea19cba53` and a 1,276,155-byte sdist at `f184d668cbf9462481166d7605fe3a45871e754286c93d4b58521fac91c9a811`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| Two separated integration review-state audits | Clean | GitHub reported zero conversation comments, reviews, inline comments, and review threads in both audits. PR #184 remained ready, clean, mergeable, exact-head, exact-base, and successful with only the expected skipped desktop umbrella. |
| Verified integration-record squash | Clean | PR #184 merged at `2026-08-13T12:13:00Z` as `9c37857cb8d0cc68fa63128091d6c116f84ef66d`. Its tree exactly equals reviewed tree `baffa85b731086ba71a247411cfbca51c4bdbc72`; its sole parent is feature squash `0c3c407c1e5d86541570c665fd305fa95e32e07a`; the DCO trailer and identity are exact; GitHub verification is valid at `2026-08-13T12:13:08Z`. The obsolete integration branch was deleted locally and remotely. |

## M77 closeout local evidence - 2026-08-13, Windows, CPython 3.12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Exact three-record closeout gate | 0 | The unchanged lock resolved 46 packages in 0.82 ms; all 320 files were format clean; Ruff and strict Pyright reported zero findings; all 840 architecture assertions passed with 1 local capability skip in 7.14 seconds; strict docs built in 1.70 seconds with only the known upstream notice. Whitespace, exact three-file scope, and full Git-object checking passed. |

## M76 local development evidence - 2026-08-13, Windows, CPython 3.12

M76 starts from exact synchronized M75 closeout
`ddf262dff7a8c93defad5a205adbaec460563439`, tree
`c124cb2573a4329c8032d1d4eeb416e2e1556d24`. The worktree was clean; local
branches were `main` plus the intended neutral feature branch, and only
`origin/main` existed remotely.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Focused primary-source direction scan | Advisory | PKWARE APPNOTE 6.3.9 reserves general-purpose bit 4 for enhanced deflating with compression method 8. Exact installed CPython 3.12.13 `ZipFile.open` source checks compressed-patch bit 5 and strong-encryption bit 6 but not bit 4; the regression also proves an otherwise normal deflated member carrying bit 4 is readable. The selected response is one method-scoped private preflight, not a broad flag allowlist or decoder. |
| First regression command with missing `.validation` parent | Invalid setup | Formatting, Ruff, and strict Pyright passed, but pytest produced 6 setup errors, 3 contract failures, and 1 pass because the requested workspace basetemp parent did not exist. This is environment/setup noise and is not the behavioral baseline. |
| `uv run --frozen pytest -q tests/architecture/test_m76_enhanced_deflate_member_preflight.py --basetemp .validation/m76-baseline` | 1 | Against unchanged M75, 7 contract assertions failed and 3 standard-library, precedence/non-scope, and protected-surface guards passed in 0.41 seconds. Exact-inventory input progressed beyond flag preflight, a later flagged member lost to earlier metadata, and the constant, method-scoped validator, producer/source contracts, and RFC/docs were absent. The corrected test was format/Ruff clean and strict Pyright reported zero findings. |
| Runtime/test implementation checkpoint | 1 | The M69/M75/M76 group passed 28 assertions and only the deliberately absent M76 RFC/docs assertion failed in 0.41 seconds. Ruff requested one mechanical verifier formatting adjustment; lint and strict Pyright reported zero findings. |
| Focused implementation/static/docs gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings. M76 passed all 10 assertions in 0.25 seconds. Strict docs built in 1.26 seconds with only the known upstream notice; whitespace passed. |
| First inherited-suite command with stale filenames | Invalid setup | Two referenced M64/M68 paths did not exist, so pytest collected no tests. Later commands in the same shell completed, but this invocation is not inherited-suite evidence. |
| Corrected inherited M64-M76 gate | 0 | The exact 13 current test files passed 136 assertions with 1 local filesystem-capability skip in 1.66 seconds. |
| First whole-tree static gate with generated basetemps present | 1 | The unchanged lock resolved 46 packages and the graphics environment checked 45 packages, but Ruff format found extracted sample copies under the workspace-local `.validation` pytest basetemps. The verified in-workspace generated directory was removed; no source file was reformatted by this attempt. |
| Clean lock, environment, and whole-tree static gate | 0 | The unchanged lock resolved 46 packages in 0.77 ms and the restored graphics environment checked 45 compatible packages. All 319 Python files were format clean; Ruff and strict Pyright reported zero findings. |
| Complete CPython 3.12 gate | 0 | CPython 3.12.13 passed 2,355 non-wgpu tests with 15 skips in 113.12 seconds. |
| Architecture and supported-Python gate | 0 | All 825 architecture assertions passed with 1 local capability skip in 7.60 seconds. CPython 3.13.13 passed 2,355 tests with 16 skips in 108.82 seconds; CPython 3.14.5 passed 2,355 with 16 skips in 115.35 seconds. The locked CPython 3.12 graphics environment was restored afterward with 45 compatible packages. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.69 seconds. Five-repeat base and graphics profiles validated. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| M1-M4 diagnostic benchmark validators | 0 | All four regenerated dirty-tree artifacts validate. M1 recorded 7 workloads and observed 1 of 2 targets; M2 validated 4 informational workloads with no targets; M3 validated 6 workloads and observed 1 of 2 targets; M4 validated 3 workloads and observed its baseline target. These remain diagnostic evidence, not release gates. |
| Pre-review reproducible distribution and release gate | 0 | Two builds reproduced a pure 274,258-byte wheel at `7ced651e7231f4308c9b092c2f4a6b6447fff7277095bd1b2f252167f0d4dff1` and a 1,262,791-byte sdist at `dfb4ee65626ac2c4d7f00137421cda4b71397feec2507bd78f6407a25a22c729`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. The 111,168-byte 50-entry sample remains `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`; the wheel has 94 entries, the sdist 518, and no inspected archive entry is native, WASM, bytecode, or retired repository-control metadata. |
| Findings-first review | Corrected | The method-8-only runtime policy, stable error, all-member ordering, owned cleanup, established error precedence, stored-member non-scope, producer compatibility, and protected surfaces are sound. Review found that public/RFC wording could imply detection of bit 4 present only in an inconsistent local header. The corrected contract states that M76 observes central-directory flags exposed by `ZipInfo`; local-header inconsistencies remain outside scope because no raw parser/header comparison is added. |
| Review-corrected static, focused, architecture, docs, and whitespace gate | 0 | All 319 files were format clean; Ruff and strict Pyright reported zero findings; all 10 M76 assertions passed in 0.95 seconds; all 825 architecture assertions passed with 1 local capability skip in 6.30 seconds; strict docs built in 1.27 seconds with only the known upstream notice; whitespace passed. |
| Record-inclusive reproducibility and release gate | 0 | Two builds reproduced a pure 274,273-byte wheel at `373dbe9ad78c4c2ba6ff96e7533a84cc812057f2a985aea06c491706112fe40f` and a 1,264,049-byte record-updated sdist at `d11c63366f4e44405f8b4b02442ef6cca9db952c3068ac82202017fc1191e96a`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this result changes the sdist; exact commit-tree artifact identity is delegated to hosted qualification. |
| Final frozen lock/static/architecture/docs/Git gate | 0 | The unchanged lock resolved 46 packages in 0.91 ms; all 319 files were format clean; Ruff and strict Pyright reported zero findings; all 825 architecture assertions passed with 1 local capability skip in 6.62 seconds; strict docs built in 1.20 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Exact scope, protected-surface, disclosure, credential, and archive audit | Clean | Exactly 16 intended paths change. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. Added/current-new content contains zero explicit development-tool identity and zero credential/private-key matches; retired repository-control metadata is absent. The 94-entry wheel and 518-entry sdist contain no native, WASM, bytecode, or retired control metadata. |
| Exact prepublication history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and merge base all resolve to exact M75 closeout `ddf262dff7a8c93defad5a205adbaec460563439`; symmetric difference is `0 0` and history is linear. Only `origin/main` exists remotely; GitHub reports no open PR, tag, or release. |
| First post-record architecture gate | 1 | Formatting, Ruff, and strict Pyright passed, but the repository metadata guard found that three new records literally named a retired control directory while claiming its absence. The architecture suite reported 1 failure, 824 passes, and 1 capability skip in 7.15 seconds. The references were neutralized before rerunning the complete gate. |
| Corrected post-record static/architecture/docs/scope gate | 0 | All 319 files were format clean; Ruff and strict Pyright reported zero findings; all 825 architecture assertions passed with 1 local capability skip in 6.96 seconds; strict docs built in 1.16 seconds with only the known upstream notice; whitespace passed and scope remained exactly 16 paths. |
| Exact-head hosted qualification | 0 | Ready PR #180 qualified exact DCO feature commit `2f93c32926dfb2aec4798fa5f4c13a2b096495c9` in run `31638620625`. Linux completed first in job `94255181714` in 7m16s; macOS job `94257190372` completed in 2m58s and Windows job `94257190469` in 4m09s after the bounded desktop fan-out. |
| Hosted test and quality suites | 0 | Linux CPython 3.12 passed 2,370 tests in 131.35 seconds; Linux 3.13 passed 2,370 with 1 skip in 111.44 seconds; Linux 3.14 passed 2,370 with 1 skip in 112.52 seconds; macOS 3.14 passed 2,370 with 1 skip in 129.29 seconds; Windows 3.14 passed 2,370 with 1 skip in 194.46 seconds. All 319 files were format clean; Ruff, strict Pyright, strict docs, all 10 real-wgpu tests on each OS, both profiles, both vertical slices, wheel smoke, deterministic staging, and complete release smoke passed. |
| Hosted artifact identity | 0 | Hosted qualification produced a pure 274,260-byte wheel at `74d28148c78151f56d366db8b64212e91ae409f722931dd0a1bc6a67150482ba` and a 1,265,082-byte sdist at `75db0570cdb93a3e7c317237712c7c717b275e8ae6417186b4119523ecb294238`. All 10 staged artifacts validated. Deterministic state and replay contracts passed; platform-specific capture hashes were not claimed to be cross-platform identical. |
| Two separated review-state audits | Clean | GitHub reported zero issue comments, reviews, inline comments, and unresolved review threads in both audits. PR #180 remained clean, mergeable, and exact to the qualified head. |
| Feature squash integration verification | Clean | PR #180 was squash-merged as `425ed21ab99d91bf4661b304bea00137117a5d27` at `2026-08-12T20:51:41Z`. Its tree exactly equals qualified feature tree `8b7f50a2efba456f1015276f1b6345466d9fa5cb`, its sole parent is exact M75 closeout `ddf262dff7a8c93defad5a205adbaec460563439`, the DCO identity is exact, and GitHub reports valid verification at `2026-08-12T20:51:45Z`. The remote feature branch and verified-obsolete local feature branch were deleted. |

## M76 integration-record local evidence - 2026-08-13, Windows, CPython 3.12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Four-file integration-record local gate | 0 | Exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, `.project/TEST_EVIDENCE.md`, and `ROADMAP.md` changed. After the sandboxed uv cache produced one access-denied infrastructure result, the unchanged lock resolved 46 packages in 0.78 ms with its managed cache available. All 319 files were format clean; Ruff and strict Pyright reported zero findings; all 825 architecture assertions passed with 1 local capability skip in 6.62 seconds; strict docs built in 1.25 seconds with only the known upstream notice; whitespace and full Git-object checking passed, with only expected unreachable development objects reported. |
| Integration-record reproducibility and release gate | 0 | Two fresh builds reproduced a pure 274,273-byte wheel at `373dbe9ad78c4c2ba6ff96e7533a84cc812057f2a985aea06c491706112fe40f` and a 1,265,304-byte source distribution at `1d55265954454f788d2a48adb6d5d7c8077272820f85b6185a7b5a4bbc094f0e`. Isolated-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. This evidence changes the packaged source archive afterward, so hosted integration-head identities remain authoritative. |
| Final evidence-inclusive integration gate | 0 | The unchanged lock resolved 46 packages in 0.82 ms; all 319 files remained format clean; Ruff and strict Pyright reported zero findings; all 825 architecture assertions passed with 1 local capability skip in 8.83 seconds; strict docs built in 1.81 seconds with only the known upstream notice. Whitespace, exact four-file scope, and full Git-object checking passed, with only expected unreachable development objects reported. |

## M76 hosted integration-record evidence - 2026-08-12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Hosted integration-record qualification | 0 | Exact DCO head `3ea7f503c9f8ce4e315bf6e119f23242c0e00c22`, tree `f626382619a628a961bbf34dbb146c1bdea6099f`, passed run `31640417965`. The trusted-base classifier identified exactly four changed paths as documentation. Linux job `94261221978` passed in 42 seconds; desktop umbrella job `94261437158` skipped with zero steps, so the closeout did not consume desktop allocations. |
| Hosted documentation/artifact gate | 0 | All 319 files were format clean; Ruff passed; strict docs built in 1.64 seconds; all 826 hosted architecture assertions passed in 10.12 seconds. Two builds reproduced a pure 274,260-byte wheel at `74d28148c78151f56d366db8b64212e91ae409f722931dd0a1bc6a67150482ba` and a 1,266,053-byte sdist at `5a7352408529da88ffe29d8f0e1bec752c5e8a2359fe0b0088c5c4482b7af31d`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| Two separated integration review-state audits | Clean | GitHub reported zero issue comments, reviews, inline comments, and unresolved review threads in both audits. PR #181 remained ready, clean, mergeable, exact-head, exact-base, and successful with only the expected skipped desktop umbrella. |
| Verified integration-record squash | Clean | PR #181 squash `224b595f185fdd16fb5ab733e60f78a61ab19f5a` has exact reviewed tree `f626382619a628a961bbf34dbb146c1bdea6099f`, sole parent M76 feature squash `425ed21ab99d91bf4661b304bea00137117a5d27`, exact DCO identity, and a valid GitHub signature verified at `2026-08-12T21:02:31Z`. The obsolete integration branch is absent remotely and locally. |

## M76 closeout local evidence - 2026-08-13, Windows, CPython 3.12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Exact three-record closeout gate | 0 | The unchanged lock resolved 46 packages in 0.79 ms; all 319 files were format clean; Ruff and strict Pyright reported zero findings; all 825 architecture assertions passed with 1 local capability skip in 8.07 seconds; strict docs built in 1.30 seconds with only the known upstream notice. Whitespace, exact three-file scope, and full Git-object checking passed, with only expected unreachable development objects reported. |
| Final evidence-inclusive closeout gate | 0 | The unchanged lock resolved 46 packages in 0.81 ms; all 319 files remained format clean; Ruff and strict Pyright reported zero findings; all 825 architecture assertions passed with 1 local capability skip in 7.64 seconds; strict docs built in 1.22 seconds with only the known upstream notice. Whitespace and exact three-file scope passed. |
| Path-filtered closeout publication and audits | Clean | Ready PR #182 contained exact DCO head `dba16136025908daa3984e336b73f26f4c5bb806`, tree `27cfc273accb3190d0c50e6a344685875cce541b`, and exactly the three project records. GitHub created no workflow run. Two separated audits found zero issue comments, reviews, inline comments, or unresolved threads; the PR remained clean, mergeable, exact-head, and exact-base. |
| Verified closeout squash and cleanup | Clean | PR #182 squash `701637f99447f4d64c84047e64ec5edfa0c6889f` has the exact reviewed tree, sole parent integration squash `224b595f185fdd16fb5ab733e60f78a61ab19f5a`, exact DCO identity, and a valid GitHub signature verified at `2026-08-12T21:08:30Z`. Both obsolete closeout branches and 32 verified workspace-local M76 validation targets were removed. Local `main`, `origin/main`, and merge base are exact closeout with symmetric difference `0 0`; only `main` exists locally/remotely and GitHub reports no open PR, tag, or release. |

## M75 local development evidence - 2026-08-13, Windows, CPython 3.12

M75 starts from exact synchronized M74 closeout
`674d74c8fc852846404813ab541aab3deffd8608`, tree
`cbe1b75ae6c3174c04b0712894244918cae69010`. The worktree was clean and only
`main` existed locally and remotely before the neutral branch was created.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Focused primary-source direction scan | Advisory | PKWARE APPNOTE 6.3.9 assigns general-purpose bit 5 to compressed patched data. Exact installed CPython 3.12.13, 3.13.13, and 3.14.5 `ZipFile.open` paths test that bit and raise `NotImplementedError("compressed patched data (flag bit 5)")`. The selected response is one exact private preflight flag, not a broad allowlist or implementation-error catch. |
| First regression static attempt | 1 | Ruff found one fixable nested-context style issue before baseline execution. The test-only notation was corrected; this attempt is not behavioral product evidence. |
| Second regression static attempt | 1 | Ruff was clean, but strict Pyright rejected an overly generic ZIP-constructor spy signature before baseline execution. The spy was narrowed to the exact binary-stream signature already used by neighboring cleanup tests; this attempt is not behavioral product evidence. |
| `uv run --frozen pytest -q tests/architecture/test_m75_compressed_patch_member_preflight.py --basetemp D:\LudoWeaveValidation\m75\baseline` | 1 | Against exact M74, 7 contract assertions failed and 3 standard-library/protected/out-of-scope guards passed in 0.34 seconds. CPython's actual raw `NotImplementedError` escaped after flag preflight; the exact-inventory path reached inventory/staging, a later flagged member lost to earlier metadata validation, and the constant, policy branch, producer/source contracts, and RFC/docs were absent. The test was format/Ruff clean and strict Pyright reported zero findings. |
| Runtime/test implementation checkpoint | 1 | One exact constant and one ordered branch after encryption implement the policy. Both affected files were format clean; Ruff and strict Pyright reported zero findings. The M69/M75 group passed 18 assertions; only the deliberately absent M75 RFC/docs assertion failed. |
| First completed-doc focused gate | 1 | All 9 behavioral/source/protected M75 assertions passed, but the docs contract required the exact phrase `before staging` while the README placed another term between those words. The documentation sentence was aligned without changing behavior. |
| Focused implementation/static/docs gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings. M75 passed all 10 assertions in 0.21 seconds; inherited M64-M75 passed 126 assertions with 1 local filesystem-capability skip in 1.18 seconds. Strict docs built in 1.22 seconds with only the known upstream notice, and whitespace passed. |
| Lock, environment, whole-tree static, and CPython 3.12 gate | 0 | The unchanged lock resolved 46 packages; the locked graphics environment checked 45 compatible packages. All 318 files were format clean; Ruff and strict Pyright reported zero findings. CPython 3.12.13 passed 2,345 tests with 15 skips in 110.48 seconds. |
| Architecture and supported-Python gate | 0 | All 815 architecture assertions passed with 1 local capability skip in 5.42 seconds. CPython 3.13.13 passed 2,345 tests with 15 skips in 102.85 seconds; CPython 3.14.5 passed 2,345 with 15 skips in 113.15 seconds. The CPython 3.12 graphics environment was restored afterward with 45 compatible packages. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.99 seconds. Five-repeat base and graphics profiles validated. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| M1-M4 diagnostic benchmark validators | 0 | All four regenerated artifacts validate. M1 recorded seven workloads and observed one of two targets; M2 validated four informational workloads with no targets; M3 validated six workloads and observed one of two targets; M4 validated three workloads and observed its baseline target. These remain diagnostic evidence, not release gates. |
| Pre-review reproducible distribution and release gate | 0 | Two builds reproduced a pure 274,103-byte wheel at `60824005e82908164ad7a6433d3647cdf011d9aa03dec884aa8d142904084784` and a 1,256,257-byte sdist at `9d33bf47e294d63a5dc6bce66d60781562676e5881158d414d849b23d785df49`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. The 111,168-byte 50-entry sample remains `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`; the wheel has 94 entries and no inspected wheel/sample entry is native or WASM. |
| Exact candidate scope and protected hashes | Clean | Exactly 16 intended paths change, including the new RFC/test paths. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. No runtime-package, dependency, benchmark, version, workflow, or release-authority path changes. |
| Findings-first review | Clean | The exact bit-5 mutation proves both CPython's member-open failure and M75's earlier stable policy. All-member ordering, source/archive cleanup, encryption precedence, unrelated-flag non-expansion, current-producer compatibility, protected surfaces, and public non-claims are covered. The runtime change is one exact constant plus one ordered branch; it does not catch `NotImplementedError` or define a broad flag policy. No product, test, RFC, or scope defect remains. |
| Record-inclusive lock/static/architecture/docs/Git-object gate | 0 | The unchanged lock resolved 46 packages in 0.81 ms; the graphics environment checked 45 compatible packages. All 318 files were format clean; Ruff and strict Pyright reported zero findings; all 815 architecture assertions passed with 1 local capability skip in 5.50 seconds; strict docs built in 1.42 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Record-inclusive reproducibility and release gate | 0 | Two builds reproduced the pure 274,103-byte wheel at `60824005e82908164ad7a6433d3647cdf011d9aa03dec884aa8d142904084784` and a 1,257,198-byte record-updated sdist at `ece63f8b3f70b3aa9600e4a64543b5a0143ba0f3c794e119d29461560936600d`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this result changes the sdist; exact commit-tree artifact identity is delegated to hosted qualification. |
| Final frozen static/architecture/docs/scope/hygiene gate | 0 | The unchanged lock resolved 46 packages in 0.77 ms; all 318 files were format clean; Ruff and strict Pyright reported zero findings; all 815 architecture assertions passed with 1 local capability skip in 5.74 seconds; strict docs built in 1.19 seconds with only the known upstream notice; whitespace and full Git-object checking passed. The candidate remained exactly 16 intended paths; protected hashes, credential/private-key hygiene, and explicit development-tool identity hygiene passed. |
| Exact prepublication history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and merge base all resolve to exact M74 closeout `674d74c8fc852846404813ab541aab3deffd8608`; symmetric difference is `0 0` and history is linear. Only `origin/main` exists remotely; GitHub reports no open PR, tag, or release. |
| Exact post-record static/architecture/docs/whitespace gate | 0 | All 318 files were format clean; Ruff and strict Pyright reported zero findings; all 815 architecture assertions passed with 1 local capability skip in 5.67 seconds; strict docs built in 1.20 seconds with only the known upstream notice; whitespace passed and the candidate remained exactly 16 paths. |
| Ready PR #177 run `31633932748` | 0 | Exact DCO head `77ab1757ea52be4c5532adfe26c27bfa202504ef`, tree `b0aac18c83fc6e93bd5fd1e1f154100e2bc75799`, passed in exactly three Linux-first allocations: Linux job `94239384400` in 7m21s, macOS `94241430591` in 3m25s, and Windows `94241430557` in 4m06s. |
| Hosted suites and artifacts | 0 | All 318 files were format clean; Ruff, strict Pyright, and strict docs passed. Linux CPython 3.12 passed 2,360 tests; Linux 3.13/3.14 and macOS/Windows 3.14 each passed 2,360 with 1 expected skip. Every OS passed 10 real-wgpu tests; profiles, examples, installed-wheel, staging, and release smokes passed. Two builds reproduced a pure 274,089-byte wheel at `af0ea15e0ac4851461a93d79b11b587d2d230fc91219c2da47acee5574901d4b` and 1,257,945-byte sdist at `7f68ef379d335c9a4b3cefb7e9409af26fb759f8ebffc28dc7a7bb11e8d43917`. |
| Hosted review and feature squash | 0 | Two separated audits found zero issue comment, review, inline comment, or thread. PR #177 squash `b86013397d5ad5f28d9a9adfe7c7f30996cbad65` has exact reviewed tree `b0aac18c83fc6e93bd5fd1e1f154100e2bc75799`, sole parent M74 closeout `674d74c8fc852846404813ab541aab3deffd8608`, exact DCO, and a valid GitHub signature verified at `2026-08-12T19:55:01Z`; the branch is absent remotely and locally. |
| Integration-record local gate | 0 | The unchanged lock resolved 46 packages in 0.82 ms; all 318 files were format clean; Ruff and strict Pyright reported zero findings; all 815 architecture assertions passed with 1 local capability skip in 5.74 seconds; strict docs built in 1.39 seconds; whitespace and Git-object checking passed. Two builds reproduced the feature-identical 274,103-byte wheel at `60824005e82908164ad7a6433d3647cdf011d9aa03dec884aa8d142904084784` and a 1,259,225-byte record-updated sdist at `5f5051d0e2831634eb2b2bb596258a2782fa83fd5063cac3854df4e296e1d2a7`; wheel, staging, and complete release smoke passed. |
| Integration hosted qualification | 0 | Exact DCO head `26640c723b48a208301c86dacc5f53772bc745fe`, tree `a8ea9e89a40adaf0125623b86face642c721533e`, passed run `31635295952` in one 38-second Linux allocation; desktop job skipped with zero steps. The gate resolved 46 packages, found 318 files format clean, passed Ruff, built strict docs in 1.26 seconds, passed 816 selected architecture assertions in 7.70 seconds, reproduced a 274,089-byte wheel `af0ea15e0ac4851461a93d79b11b587d2d230fc91219c2da47acee5574901d4b` and 1,259,477-byte sdist `bf99be5f80bf644173b309efb8c75950c5de718efaff8acdcea71e34361c3a1c`, and passed all smokes. |
| Integration audits and squash | 0 | Two separated audits found zero comment, review, inline comment, or thread. PR #178 squash `57dc9af600a5e651bc051fb5a47b2902cb2e2403` has exact reviewed tree `a8ea9e89a40adaf0125623b86face642c721533e`, sole feature-squash parent `b86013397d5ad5f28d9a9adfe7c7f30996cbad65`, exact DCO, and valid signature verified at `2026-08-12T20:00:32Z`; branch deleted. |
| Closeout local qualification | 0 | All 318 files were format clean; Ruff and strict Pyright reported zero findings; all 815 architecture assertions passed with 1 local capability skip in 5.89 seconds; strict docs built in 1.28 seconds; whitespace and Git-object checking passed. The diff was exactly the three neutral project records. |

## M74 local development evidence - 2026-08-13, Windows, CPython 3.12

M74 starts from exact synchronized M73 closeout
`7ecb584e71a375d1ab63ee8134e7493e418dedff`, tree
`fafa86abb05929711e38f34b4d219bcfc7161637`. The worktree was clean and only
`main` existed locally and remotely before the neutral branch was created.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Focused primary-source direction scan | Advisory | Official Python 3.12-3.14 documentation defines `zlib.error` for compression/decompression failures. Exact installed CPython 3.12.13 and 3.13.13 with zlib 1.3.1 and CPython 3.14.5 with zlib-ng 1.3.1 route deflated ZIP member bytes directly through a decompressor that can raise it. The selected response is one exact private exception addition, not an EOF/filesystem/broad compression/general catch or archive-safety claim. |
| `uv run --frozen pytest -q tests/architecture/test_m74_content_silent_sample_zip_decompression_failures.py --basetemp D:\LudoWeaveValidation\m74\baseline` | 1 | Exact M73 failed 4 assertions and passed 4 policy/producer/protected guards in 0.38 seconds. Two actual checksum-admitted invalid raw-deflate paths escaped as `zlib.error: Error -3 while decompressing data: invalid block type`; the exact source catch and RFC/docs were absent. The new regression was format/Ruff clean and strict Pyright reported zero findings. |
| First runtime/test implementation checkpoint | 1 | The two-line runtime change normalized both actual decompression paths and kept affected formatting, Ruff, and strict Pyright clean. The combined M73/M74 group passed 14 assertions; M73's historical whole-tuple source assertion and the deliberately absent M74 RFC/docs assertion failed. |
| Corrected implementation checkpoint | 1 | M73's inherited source guard now asserts its required exact members without freezing the whole additive tuple. All 15 behavioral/source/protected M73/M74 assertions passed in 0.43 seconds; only the deliberately absent M74 RFC/docs assertion failed. All three affected Python files remained format/Ruff clean and strict Pyright reported zero findings. |
| Focused implementation/static/docs gate | 0 | The three affected Python files were format clean; Ruff and strict Pyright reported zero findings. M74 passed all 8 assertions in 0.22 seconds; inherited M64-M74 passed 116 assertions with 1 local filesystem-capability skip in 1.02 seconds. Strict docs built in 1.44 seconds with only the known upstream notice, and whitespace passed. |
| Lock, environment, whole-tree static, and CPython 3.12 gate | 0 | The unchanged lock resolved 46 packages in 0.73 ms and the locked graphics environment checked 45 packages. All 317 files were format clean; Ruff and strict Pyright reported zero findings. CPython 3.12 passed 2,335 tests with 15 skips in 109.05 seconds. |
| Architecture and supported-Python gate | 0 | All 805 architecture assertions passed with 1 local capability skip in 5.78 seconds. CPython 3.13 passed 2,335 tests with 16 skips in 106.22 seconds; CPython 3.14 passed 2,335 with 16 skips in 110.75 seconds. The CPython 3.12 graphics environment was restored afterward with 45 compatible packages. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.64 seconds. Five-repeat base and graphics profiles validated. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| M1-M4 diagnostic benchmark validators | 0 | All four regenerated artifacts validate. M1 recorded seven workloads and observed one of two targets; M2 validated four informational workloads with no targets; M3 validated six workloads and observed one of two targets; M4 validated three workloads and observed its baseline target. These remain diagnostic evidence, not release gates. |
| Pre-review reproducible distribution and release gate | 0 | Strict docs built in 1.33 seconds with only the known upstream notice; whitespace and full Git-object checking passed. Two builds reproduced a pure 273,952-byte wheel at `ada989ae548bdf51f124d39080a83580711e58e5148b149b28a72dbaf59c8bcf` and a 1,247,726-byte sdist at `f06f525fda77ddd9d618ac92a4c7bbfb2f33cc4c29d6358c1310106a71951988`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. The 111,168-byte 50-entry sample remains `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`; the wheel has 94 entries, the sdist 514, and no inspected archive contains native/WASM entries. |
| Exact candidate scope and protected hashes | Clean | Exactly 17 intended paths change, including two new RFC/test paths. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. No runtime-package, dependency, benchmark, version, workflow, or release-authority path changes. |
| Findings-first review | Clean | The catch is limited to exact `zlib.error`; the actual invalid-block fixture preserves valid container metadata, exact inventory, and a matching admitted checksum while corrupting only the raw-deflate block type. Cleanup and rendered-context assertions cover the post-staging path; EOF and verifier-policy categories stay distinct. M73's inherited source guard is additive without permitting broad catches. No product, test, RFC, or scope defect remains. The M72-M74 group passed 25 assertions in 0.40 seconds; all 317 files were format clean; Ruff and strict Pyright reported zero findings; strict docs built in 1.45 seconds with only the known upstream notice; whitespace passed. |
| Record-inclusive lock/static/architecture/docs/Git-object gate | 0 | The unchanged lock resolved 46 packages in 0.83 ms; the graphics environment checked 45 compatible packages. All 317 files were format clean; Ruff and strict Pyright reported zero findings; all 805 architecture assertions passed with 1 local capability skip in 5.68 seconds; strict docs built in 1.38 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Record-inclusive reproducibility and release gate | 0 | Two builds reproduced the pure 273,952-byte wheel at `ada989ae548bdf51f124d39080a83580711e58e5148b149b28a72dbaf59c8bcf` and a 1,249,215-byte record-updated sdist at `ab78ce123bb24d9bee5e70871f13238745e31ded5da826e0a2969b2db03212a5`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this result changes the sdist; exact commit artifact identity is delegated to hosted qualification. |
| Final frozen lock/static/architecture/docs/whitespace gate | 0 | The unchanged lock resolved 46 packages in 0.75 ms; all 317 files were format clean; Ruff and strict Pyright reported zero findings; all 805 architecture assertions passed with 1 local capability skip in 5.51 seconds; strict docs built in 1.19 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Exact prepublication scope/history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and the merge base all resolve to exact M73 closeout `7ecb584e71a375d1ab63ee8134e7493e418dedff`; the symmetric difference is `0 0` and history is linear. The candidate remains exactly 17 intended paths and protected surfaces are unchanged. GitHub reports no open pull request, only remote `main`, no tag, and no release. Changed M74 content contains no credential/private-key or explicit development-tool identity marker. |
| Exact post-record static/architecture/docs/whitespace gate | 0 | All 317 files were format clean; Ruff and strict Pyright reported zero findings; all 805 architecture assertions passed with 1 local capability skip in 5.72 seconds; strict docs built in 1.17 seconds with only the known upstream notice; whitespace passed and the candidate remained exactly 17 paths. |

## M74 hosted feature evidence - 2026-08-12

| Command or review | Exit | Result |
| --- | ---: | --- |
| Ready PR #174 run `31629156916` | 0 | Exact DCO head `49f38b841d497c4bc84666d64674185290adb836`, tree `5bf17270a8bf9f84314bff38c93c7aeb0502b347`, passed in exactly three Linux-first allocations. Linux job `94223190169` passed in 7m19s; only then did macOS `94225265967` and Windows `94225265980` begin, passing in 2m50s and 4m17s. |
| Hosted supported-Python and static/docs gates | 0 | All 317 files were format clean; Ruff and strict Pyright were clean; strict docs built in 1.58 seconds. Linux CPython 3.12 passed 2,350 tests; Linux 3.13/3.14 and macOS/Windows 3.14 each passed 2,350 tests with 1 expected skip. |
| Hosted graphics, profiles, examples, distribution, and smoke | 0 | Every allocated OS passed 10 real-wgpu tests, its graphics profile, Clockwork Arena, and Agent World Builder; Linux also passed the base profile. Two exact-head builds reproduced a pure 273,938-byte wheel at `711a4379ef59c4c2cd2bf1b3d11ce6a84de805d2d7c7ab97f5c4bab4ee841238` and a 1,249,974-byte sdist at `6b7e7c90247251c0922eb895a3ded86b1ca785587f4e5505a6425380c0e507b6`. Installed-wheel smoke, deterministic staging, and complete M74 release smoke passed. |
| Delayed exact-head review audits | 0 | Two separated audits found zero issue comments, reviews, inline comments, and review threads. PR #174 remained ready, clean, mergeable, exact-head, exact-base, and fully checked. |
| Feature squash verification | 0 | PR #174 squash `88960cccf31458a0d654062876b46eea616374dc` has tree `5bf17270a8bf9f84314bff38c93c7aeb0502b347`, exactly matching reviewed head `49f38b841d497c4bc84666d64674185290adb836`; its sole parent is exact M73 closeout `7ecb584e71a375d1ab63ee8134e7493e418dedff`. GitHub reports a valid signature verified at `2026-08-12T18:59:26Z` and an exact DCO trailer. The remote branch returned 404, and the exact-tree-equivalent local feature branch was deleted. |
| Integration-record local gate | 0 | The unchanged lock resolved 46 packages in 0.78 ms; all 317 files passed formatting; Ruff and strict Pyright reported zero findings; all 805 architecture assertions passed with 1 local capability skip in 6.58 seconds; strict docs built in 1.39 seconds with only the known upstream notice; whitespace and full Git-object checking passed. Two fresh builds reproduced the feature-identical pure 273,952-byte wheel at `ada989ae548bdf51f124d39080a83580711e58e5148b149b28a72dbaf59c8bcf` and the 1,251,607-byte record-updated sdist at `53a335c20066cc5b7f004ebb66f41ec14aecefec45dbcbecd898ffc7f110ccfa`; installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Exact integration-commit artifact identity remains delegated to hosted qualification because this row changes the sdist. |
| Integration-record freeze | 0 | All 317 files were format clean; Ruff and strict Pyright reported zero findings; all 805 architecture assertions passed with 1 local capability skip in 6.95 seconds; strict docs built in 1.27 seconds with only the known upstream notice; whitespace and full Git-object checking passed. The diff remained exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, `.project/TEST_EVIDENCE.md`, and `ROADMAP.md`, with zero credential/private-key or explicit development-tool identity matches. |
| Integration-record publication and hosted qualification | 0 | Exact DCO head `fd3185ab0213ffdecb2225877145ebf865199513`, tree `f3cc51c38ce0c3682449225e84426b722e04724d`, passed run `31630962285` in one 38-second Linux allocation, job `94229285194`; desktop umbrella job `94229481755` skipped with zero steps. The gate resolved 46 packages in 0.67 ms, found all 317 files format clean, passed Ruff, built strict docs in 1.29 seconds, passed 806 documentation-selected architecture assertions in 7.95 seconds, reproduced artifacts, and passed installed-wheel, staging, and complete release smokes. |
| Hosted integration artifacts | 0 | Two exact-head builds reproduced the pure 273,938-byte wheel at `711a4379ef59c4c2cd2bf1b3d11ce6a84de805d2d7c7ab97f5c4bab4ee841238` and a 1,252,100-byte sdist at `4b974e44eed847474d621ebfc4065b9011b177986374287de7dbe50f6076e5e8`. |
| Separated integration review audits | Clean | Two separated audits found zero issue comment, review, inline comment, or review thread. PR #175 remained clean, mergeable, and on exact qualified head `fd3185ab0213ffdecb2225877145ebf865199513`. |
| Verified integration-record squash | 0 | PR #175 squash `01d79609c81f13ea637addd9c41bd019d0bdebb0` has exact reviewed tree `f3cc51c38ce0c3682449225e84426b722e04724d`, sole parent M74 feature squash `88960cccf31458a0d654062876b46eea616374dc`, exact DCO, and a valid GitHub signature verified at `2026-08-12T19:07:49Z`. The integration branch is absent remotely and locally. |
| Closeout local qualification | 0 | The unchanged lock resolved 46 packages in 0.73 ms; all 317 files were format clean; Ruff and strict Pyright reported zero findings; all 805 architecture assertions passed with 1 local capability skip in 6.95 seconds; strict docs built in 1.20 seconds with only the known upstream notice; whitespace and full Git-object checking passed. The diff is exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, and `.project/TEST_EVIDENCE.md`; it changes no workflow, runtime, verifier, producer, dependency, package, test, public-documentation, or roadmap surface and contains zero credential/private-key or explicit development-tool identity matches. |

## M73 local development evidence - 2026-08-13, Windows, CPython 3.12

M73 starts from exact synchronized M72 closeout
`f4afb40aade2b1a59b7ceabf6f1db158b450b7cd`, tree
`90e987138c2fa09fe62db2428e23421ec511a7a5`. The worktree was clean and only
`main` existed locally and remotely before the neutral branch was created.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Focused primary-source direction scan | Advisory | Python documents `UnicodeDecodeError` and its invalid-input/offset attributes. Exact installed CPython 3.12.13, 3.13.13, and 3.14.5 `zipfile` source strictly decodes UTF-8-marked names in both the central directory and local header. The selected response is one exact private exception addition, not a broad Unicode/value catch or archive-safety claim. |
| First baseline attempt | 1 | The new test was statically clean except for a requested mechanical format, but five behavior cases failed in setup because M72 cleanup had removed the parent of external `D:\LudoWeaveValidation\m73\baseline`. Two missing-contract/docs assertions failed and one protected-boundary guard passed. This is not behavioral product evidence. |
| `uv run --frozen pytest -q tests/architecture/test_m73_content_silent_sample_zip_text_failures.py --basetemp D:\LudoWeaveValidation\m73\baseline` | 1 | After restoring the exact validation parent and formatting the test, 5 assertions failed and 3 policy/producer/protected guards passed in 0.41 seconds against exact M72. Actual malformed central-directory and local-header UTF-8 names escaped as raw `UnicodeDecodeError`; the exact catch contract and RFC/docs were absent. Ruff and strict Pyright were clean. |
| Runtime/test implementation checkpoint | 1 | All three affected Python files were format/Ruff clean and strict Pyright reported zero findings. Sixteen M72/M73 behavioral/source/protected assertions passed in 0.48 seconds; only the deliberately absent RFC/documentation assertion failed. |
| Focused implementation/static/docs gate | 0 | The affected Python files were format clean; Ruff and strict Pyright reported zero findings. M73 passed all 8 assertions in 0.22 seconds; inherited M64-M73 passed 108 assertions with 1 local capability skip in 0.94 seconds. Strict docs built in 1.33 seconds with only the known upstream Material notice, and whitespace passed. |
| Lock, environment, whole-tree static, and CPython 3.12 gate | 0 | The unchanged lock resolved 46 packages in 0.71 ms and the locked graphics environment checked 45 packages. All 316 files were format clean; Ruff and strict Pyright reported zero findings. CPython 3.12 passed 2,337 tests with 15 skips in 114.44 seconds. |
| Architecture and supported-Python gate | 0 | All 797 architecture assertions passed with 1 local capability skip in 5.68 seconds. CPython 3.13 passed 2,327 tests with 16 skips in 103.70 seconds; CPython 3.14 passed 2,327 with 16 skips in 109.82 seconds. The CPython 3.12 graphics environment was restored afterward. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.32 seconds. Five-repeat base and graphics profiles validated. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
...
| Pre-review reproducible distribution and release gate | 0 | Two builds reproduced a pure 273,839-byte wheel at `32553b1c0bf9eea3bbd3b6ab63d51ee97ef4a2d6429054dc2049439b3175af5d` and a 1,240,741-byte sdist at `5c39589b70170715d04a1a4c83a147616f7953b53ec8f9348cb9c3c78f746877`. Installed-wheel smoke, deterministic ten-artifact staging, complete release smoke, strict docs, whitespace, and full Git-object checking passed. The 111,168-byte 50-entry sample remains `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`; the wheel has 94 entries, the sdist 512, and no inspected archive contains native/WASM entries. |
| Findings-first review | Corrected | The exact `UnicodeDecodeError` catch is bounded to the private extractor, preserves policy/other failure categories, and uses M72's stable suppressed-context error after cleanup. No product, RFC, or scope defect remained. Review strengthened the local-header regression to observe archive closure and made M72's historical catch extraction precise. The first strengthened gate passed runtime/docs but strict Pyright rejected an overly generic test recorder; an exact one-stream signature corrected it. |
| Review-corrected focused/static/docs gate | 0 | Both affected regression files were format/Ruff clean and strict Pyright reported zero findings. The M72/M73 group passed 17 assertions in 0.31 seconds; inherited M64-M73 passed 108 with 1 local capability skip in 1.07 seconds; strict docs built in 1.20 seconds with only the known upstream notice; whitespace passed. |
| Record-inclusive lock/static/architecture/docs/Git-object gate | 0 | The unchanged lock resolved 46 packages in 0.76 ms; the graphics environment checked 45 packages. All 316 files were format clean; Ruff and strict Pyright reported zero findings; all 797 architecture assertions passed with 1 local capability skip in 5.55 seconds; strict docs built in 1.42 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Record-inclusive reproducibility and release gate | 0 | Two builds reproduced the pure 273,839-byte wheel at `32553b1c0bf9eea3bbd3b6ab63d51ee97ef4a2d6429054dc2049439b3175af5d` and a 1,242,180-byte record-updated sdist at `5fc6b835edafdc6903b343ca038ed2b71a3f02f048536ed2e523b31ba5d82e8e`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this result changes the sdist; exact commit artifact identity is delegated to hosted qualification. |
| Exact candidate scope and protected hashes | Clean | Exactly 17 intended paths changed. CI remains `258216325687f59fda44763f875000ef91a5790098ae8b92b2207436dab95946`; release workflow `c2eea00debc2cdd742ac34075f1223d33820bb103708ad986637b6f1eefb60a5`; sample producer `d6533cb45eac8d87e0ea47a59c0e03271e3e89bc38eea5c6db690785cfa131ca`; package metadata `42a7363b8b86a9fb875e48f4e07a071d90e8b1a7ce11865414b17b20adaa2ab1`; lock `e2c7b4c801e59dba77a6c0cc6efc45e27d0baa466d17c2e5ed76c0dd27ea11ed`. No runtime-package, dependency, benchmark, version, workflow, or release-authority path changed. |
| Final frozen lock/static/architecture/docs/whitespace gate | 0 | The unchanged lock resolved 46 packages in 0.85 ms; all 316 files were format clean; Ruff and strict Pyright reported zero findings; all 797 architecture assertions passed with 1 local capability skip in 5.76 seconds; strict docs built in 1.20 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Exact prepublication scope/history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, `origin/main`, and the merge base all resolve to exact M72 closeout `f4afb40aade2b1a59b7ceabf6f1db158b450b7cd`; the symmetric difference is `0 0` and history is linear. The candidate remains exactly 17 intended paths and protected surfaces are unchanged. GitHub reports no open pull request, only remote `main`, no tag, and no release. Changed M73 content contains no credential/private-key or explicit development-tool identity marker; one repository-wide hygiene match is an unrelated historical query-parameter fixture, not credential material. |
| Exact post-record static/architecture/docs/whitespace gate | 0 | All 316 files were format clean; Ruff and strict Pyright reported zero findings; all 797 architecture assertions passed with 1 local capability skip in 5.75 seconds; strict docs built in 1.19 seconds with only the known upstream notice; whitespace passed and the candidate remained exactly 17 paths. |
| Feature publication and exact-head qualification | 0 | DCO head `a927c23b0e6751bd4a7876dc74a7b89f09d698be`, tree `562cd0a49c641270c5989e38055d8539eef2e3ca`, passed hosted run `31624395783` in exactly three Linux-first allocations. Linux passed in 5m57s, macOS in 2m13s, and Windows in 4m1s. Linux CPython 3.12 passed 2,342 tests; Linux 3.13/3.14 and macOS/Windows 3.14 each passed 2,342 tests with 1 expected skip. Every OS passed 10 real-wgpu tests, its graphics profile, Clockwork Arena, and Agent World Builder; Linux also passed the base profile, static/docs, artifact, installed-wheel, staging, and release smokes. |
| Hosted feature artifacts | 0 | Two exact-head builds reproduced a pure 273,827-byte wheel at `b959f2ef31753f1a4514fbdcdc29695d25f3d82f71203df01f6208c24ea76afd` and a 1,243,346-byte sdist at `81631ddc7dcc79155b1e53b36d276e934ac62526f49749b78a7ab3b954ae7510`. |
| Separated hosted review audits | Clean | Two separated audits found no issue comment, review, inline comment, or review thread. PR #171 remained clean, mergeable, and on the exact qualified head. |
| Verified feature integration | 0 | PR #171 squash `5b9d42fba4cfc1a990bce70c1d4ea4f2e7ab04e4` has exact reviewed tree `562cd0a49c641270c5989e38055d8539eef2e3ca`, sole parent M72 closeout `f4afb40aade2b1a59b7ceabf6f1db158b450b7cd`, exact DCO, and a valid GitHub signature verified at `2026-08-12T17:59:03Z`. The feature branch is absent remotely and locally. |
| Integration-record local gate | 0 | The unchanged lock resolved 46 packages in 0.81 ms; all 316 files passed formatting; Ruff and strict Pyright reported zero findings; all 797 architecture assertions passed with 1 local capability skip in 5.56 seconds; strict docs built in 1.41 seconds with only the known upstream notice; whitespace and full Git-object checking passed. Two fresh builds reproduced the feature-identical pure 273,839-byte wheel at `32553b1c0bf9eea3bbd3b6ab63d51ee97ef4a2d6429054dc2049439b3175af5d` and the 1,244,658-byte record-updated sdist at `037d02277b58a7dc5c23cc820216deee675b8bf3fddb7d1d7cc22d1aa1dabc86`; installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Exact integration-commit artifact identity remains delegated to hosted qualification because this row changes the sdist. |
| Integration-record freeze | 0 | All 316 files were format clean; Ruff and strict Pyright reported zero findings; all 797 architecture assertions passed with 1 local capability skip in 5.53 seconds; strict docs built in 1.27 seconds with only the known upstream notice; whitespace passed and scope remained exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, `.project/TEST_EVIDENCE.md`, and `ROADMAP.md`. |
| Integration-record publication and hosted qualification | 0 | Exact DCO head `ddee71f4a4a9ed84679092c5734e282975004bcd`, tree `b1c99b4cc173e82bd35592ed59406198e935b461`, passed run `31626186623` in one 46-second Linux allocation; the desktop umbrella skipped with zero steps. The gate resolved 46 packages in 0.65 ms, found all 316 files format clean, passed Ruff, built strict docs in 1.67 seconds, passed 798 selected architecture assertions in 9.66 seconds, reproduced artifacts, and passed installed-wheel, staging, and complete release smokes. |
| Hosted integration artifacts | 0 | Two exact-head builds reproduced the pure 273,827-byte wheel at `b959f2ef31753f1a4514fbdcdc29695d25f3d82f71203df01f6208c24ea76afd` and a 1,245,053-byte sdist at `59e8a080bdc3e3e1b6680f52c17de7c903d91c68eb6dc4001232d7240f7634dd`. |
| Separated integration review audits | Clean | Two separated audits found no issue comment, review, inline comment, or review thread. PR #172 remained clean, mergeable, and on exact qualified head `ddee71f4a4a9ed84679092c5734e282975004bcd`. |
| Verified integration-record squash | 0 | PR #172 squash `bb7ca9da09d36fb166057b73e4db4d0fc806cdd0` has exact reviewed tree `b1c99b4cc173e82bd35592ed59406198e935b461`, sole parent M73 feature squash `5b9d42fba4cfc1a990bce70c1d4ea4f2e7ab04e4`, exact DCO, and a valid GitHub signature verified at `2026-08-12T18:11:17Z`. The integration branch is absent remotely and locally. |
| Closeout local gate | 0 | The unchanged lock resolved 46 packages in 0.78 ms; all 316 files were format clean; Ruff and strict Pyright reported zero findings; all 797 architecture assertions passed with 1 local capability skip in 5.62 seconds; strict docs built in 1.24 seconds with only the known upstream notice; whitespace, full Git-object checking, and exact three-file scope passed. |
| Closeout freeze and hygiene review | 0 | All 316 files remained format clean; Ruff and strict Pyright reported zero findings; all 797 architecture assertions passed with 1 local capability skip in 5.74 seconds; strict docs built in 1.19 seconds with only the known upstream notice. Whitespace, exact three-file scope, protected-surface isolation, credential/private-key hygiene, and explicit development-tool identity hygiene passed. |

## M72 local development evidence - 2026-08-13, Windows, CPython 3.12

M72 starts from exact synchronized M71 closeout
`de510b5cb44a011264a4b28f6fbbf0b59e0339e8`, tree
`498e6e8f06509075b05d58e2be72f94c1d0818cb`. The worktree was clean and only
`main` existed locally and remotely before the neutral branch was created.

| Command or review | Exit | Result |
| --- | ---: | --- |
| Focused primary-source direction scan | Advisory | Python documents `BadZipFile` and `LargeZipFile`; exact locally installed CPython 3.12-3.14 source shows archive-controlled names in CRC, central/local-name mismatch, and overlapping-entry diagnostics. The selected response is a narrow private parser-exception boundary, not a broad catch or archive-safety claim. |
| `uv run --frozen pytest -q tests/architecture/test_m72_content_silent_sample_zip_failures.py --basetemp D:\LudoWeaveValidation\m72\baseline` | 1 | Six assertions failed and three policy/producer/protected-surface guards passed in 0.41 seconds against exact M71. Raw constructor `BadZipFile`, archive-controlled local-name mismatch detail, and synthetic `LargeZipFile` escaped; no stable wrapper, suppressed rendered context, close proof, source contract, RFC, or docs existed. |
| First focused static attempt | 1 | Both affected files were formatted, but Ruff correctly rejected one non-raw regex literal before Pyright or pytest ran. The test-only notation was corrected without changing behavior. |
| Runtime/test implementation checkpoint | 1 | Both affected files were format/Ruff clean and strict Pyright reported zero findings. Eight behavioral/source/protected assertions passed in 0.29 seconds; only the deliberately absent RFC/documentation assertion failed. |
| Focused implementation/static/docs gate | 0 | Both affected Python files were format clean; Ruff and strict Pyright reported zero findings. M72 passed all 9 assertions in 0.23 seconds; inherited M64-M72 passed 100 assertions with 1 local capability skip in 0.84 seconds. Strict docs built in 1.16 seconds with only the known upstream Material notice, and whitespace passed. |
| Lock, environment, whole-tree static, and CPython 3.12 gate | 0 | The unchanged lock resolved 46 packages in 0.77 ms and the locked graphics environment checked 45 packages. All 315 Python files were format clean; Ruff and strict Pyright reported zero findings. CPython 3.12 passed 2,329 non-wgpu tests with 15 skips in 113.83 seconds. |
| Architecture and supported-Python gate | 0 | All 789 architecture assertions passed with 1 local capability skip in 5.36 seconds. CPython 3.13 passed 2,319 tests with 16 skips in 104.89 seconds; CPython 3.14 passed 2,319 with 16 skips in 110.24 seconds. The CPython 3.12 graphics environment was restored afterward. |
| Real-wgpu, profiles, and vertical slices | 0 | All 10 real-wgpu tests passed in 7.72 seconds. Five-repeat base and graphics profiles validated. Clockwork Arena reproduced state `sha256:c8cd6e3d7706e22003e11ccaf8e63b72627c364d42e6e1889c377d562cd3c859` and capture `05fc014f471d5094f08c8151c650530a6f61016e7b38ee6908306f0ba0b2e906`; Agent World Builder reproduced state `sha256:ad940fab4c432f3c67f5e217f9c7f7460c28973f21ac2f85feb74d9666346be7`, capture `sha256:8e8cf5d6cbf1a73ecba00269c63125816db208b090a59d3fdba4ead5d6c31850`, and replay `sha256:d5051aa5b4a004e48f449940ec4788f8f227d4509d80f080f6371d7c9299b2ef`. |
| M1-M4 diagnostic benchmark validators | 0 | All four stored artifacts validate. M1 recorded seven workloads and observed one of two targets; M2 validated four informational workloads with no targets; M3 validated six workloads and observed neither target; M4 validated three workloads and observed its baseline target. These remain diagnostic evidence, not release gates. |
| Pre-review reproducible distribution and release gate | 0 | Two builds reproduced a pure 273,687-byte wheel at `c2a2ea16e22be7151b0944096a96305d161d935d57e15ad94932d9721ca4e759` and a 1,234,046-byte sdist at `b9a318bc9f8b1aaa684d96f8bad56a10de74656b7c16a636908160403005b151`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. The 111,168-byte 50-entry sample ZIP remains `52e3fe162b844ba2c88634871e3d2d67a9afbf42fc1cd2c74b508186f786f2b3`; the wheel has 94 entries, the sdist 510, and no inspected archive contains native/WASM entries. |
| Findings-first review | Corrected | The exception catch is limited to `BadZipFile`/`LargeZipFile`; inner contexts complete cleanup first; rendered output hides archive-controlled context while the exception remains programmatically inspectable; verifier policy errors and producer behavior remain intact. No code/test/RFC finding remained. The new concise README status named M71, but the legacy detailed status still ended at M70 and omitted M71; it now states M0-M71 and includes the snapshot. Exact scope is 16 paths with no workflow, runtime package, producer, benchmark, dependency, metadata, or lock change. |
| Review-corrected focused/static/docs gate | 0 | Both affected Python files remained format/Ruff/strict-Pyright clean; M64-M72 passed 100 assertions with 1 local capability skip in 0.97 seconds; strict docs built in 1.33 seconds with only the known upstream notice; whitespace passed. |
| Record-inclusive lock/static/architecture/docs/Git-object gate | 0 | The unchanged lock resolved 46 packages in 0.85 ms; the graphics environment checked 45 packages. All 315 files were format clean; Ruff and strict Pyright reported zero findings; all 789 architecture assertions passed with 1 local capability skip in 5.16 seconds; strict docs built in 1.22 seconds with only the known upstream notice; whitespace passed; full Git-object checking reported only pre-existing unreachable objects and exited zero. |
| Record-inclusive reproducibility and release gate | 0 | Two builds reproduced a pure 273,704-byte review-corrected wheel at `11e929dbab9214c48bc621878de553a030589b39967abc87f43fab40bf4cd77e` and a 1,235,263-byte record-updated sdist at `b0372c2b5efbc486fef9cc52dd63fd515f3d095c205d1e32aa6103e1c9735a3a`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. Recording this result changes the sdist; exact commit artifact identity is delegated to hosted qualification. |
| Final frozen lock/static/architecture/docs/whitespace gate | 0 | The unchanged lock resolved 46 packages in 0.76 ms; all 315 files were format clean; Ruff and strict Pyright reported zero findings; all 789 architecture assertions passed with 1 local capability skip in 5.44 seconds; strict docs built in 1.38 seconds with only the known upstream notice; whitespace passed. |
| Exact prepublication scope/history/remote audit | Clean | After `git fetch --prune origin`, feature `HEAD`, local `main`, and `origin/main` all resolve to exact M71 closeout `de510b5cb44a011264a4b28f6fbbf0b59e0339e8`; the symmetric difference is `0 0`. History is linear through the verified M71 feature/integration/closeout sequence. The candidate is exactly 16 intended paths. Protected workflow, release-workflow, producer, package-metadata, and lock hashes remain exact. GitHub reports no open pull request, only remote `main`, no tag, and no release. Changed content contains no credential/private-key or explicit development-tool identity marker. |
| Exact post-record static/architecture/docs/whitespace gate | 0 | All 315 files were format clean; Ruff and strict Pyright reported zero findings; all 789 architecture assertions passed with 1 local capability skip in 5.95 seconds; strict docs built in 1.59 seconds with only the known upstream notice; whitespace passed. |
| Exact published feature head | DCO | Commit `a8af08274f9e4f8cc686ee0782ef2e2fbb27e4d2`, tree `df4fd81c99f16b0e95f00eb485509079be73ac55`, has sole parent M71 closeout and exact `Signed-off-by: Louijie Compo <louijie.compo@gmail.com>`. PR #168 was ready against `main` and exact-head run `31620403869` classified it substantive. |
| Hosted Linux qualification | 0 | Job `94193530544` passed in 4m59s. CPython 3.12, 3.13, and 3.14 each passed 2,334 tests, with 1 expected skip on 3.13/3.14. Formatting, Ruff, strict Pyright/docs, 10 real-wgpu tests, both profiles, both vertical slices, reproducible build, wheel smoke, staging, and complete release smoke passed. |
| Hosted macOS qualification | 0 | Job `94194971528` passed in 3m6s. Ten real-wgpu tests, the three-workload graphics profile, Clockwork Arena, Agent World Builder, and CPython 3.14 with 2,334 passes and 1 expected skip all passed. |
| Hosted Windows qualification | 0 | Job `94194971578` passed in 3m57s. Ten real-wgpu tests, the three-workload graphics profile, Clockwork Arena, Agent World Builder, and CPython 3.14 with 2,334 passes and 1 expected skip all passed. |
| Hosted artifact identity | 0 | Two exact-head builds reproduced a pure 273,690-byte wheel at `4deb9529de9a328e2d9c6f422527c21b6faf47d1c7f726865a10dffb6a26e4a9` and a 1,236,335-byte sdist at `602a9380711ecc9fe7856af6489ef10fd8b5e66edec31b3f672d737586fcf6fe`; installed-wheel, staging, and complete release smoke passed. |
| Two separated GitHub review audits | Clean | Both exact-head audits found zero issue comments, reviews, inline comments, and review threads. PR #168 remained ready, clean, mergeable, and at `a8af08274f9e4f8cc686ee0782ef2e2fbb27e4d2`. |
| Feature squash verification | 0 | PR #168 squash `65a1e90901964f40f3ef9ace63d7700f0fccd796` has exact reviewed tree `df4fd81c99f16b0e95f00eb485509079be73ac55`, sole parent M71 closeout, exact DCO, and GitHub-valid signature verified at `2026-08-12T17:10:27Z`. The remote feature branch was deleted; the verified obsolete local feature branch was then deleted. |
| Integration-record lock/static/architecture/docs/Git-object gate | 0 | The exact four paths are `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, `.project/TEST_EVIDENCE.md`, and `ROADMAP.md`. The unchanged lock resolved 46 packages in 0.78 ms; all 315 files were format clean; Ruff and strict Pyright reported zero findings; all 789 architecture assertions passed with 1 local capability skip in 5.73 seconds; strict docs built in 1.22 seconds with only the known upstream notice; whitespace and full Git-object checking passed. |
| Integration-record reproducibility and release gate | 0 | Two builds reproduced the feature-identical pure 273,704-byte wheel at `11e929dbab9214c48bc621878de553a030589b39967abc87f43fab40bf4cd77e` and a 1,237,546-byte record-updated sdist at `981ad66a21e308ca29cd14abade30c4e8a80228425b479fd2645557d15607ac8`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| Integration-record final freeze and scope audit | 0 | The unchanged lock resolved 46 packages in 0.78 ms; all 315 files were format clean; Ruff and strict Pyright reported zero findings; all 789 architecture assertions passed with 1 local capability skip in 5.48 seconds; strict docs built in 1.17 seconds with only the known upstream notice; whitespace passed; the candidate remained exactly the four intended record/roadmap paths. |
| Hosted integration-record qualification | 0 | Exact DCO head `f4131213e2221e7316414448331decc09a6a2900`, tree `d5533287cdc618391afb15d5ebeb73b2c109becb`, passed run `31621804212` in one 44-second Linux allocation; desktop umbrella job `94198424657` skipped with zero steps. Job `94198207272` classified exactly four changed paths as documentation, found all 315 files format clean, passed Ruff and strict docs in 1.66 seconds, passed 790 architecture assertions in 9.75 seconds, reproduced artifacts, and passed wheel/staging/release smoke. |
| Hosted integration artifact identity | 0 | Two exact-head builds reproduced the feature-identical pure 273,690-byte wheel at `4deb9529de9a328e2d9c6f422527c21b6faf47d1c7f726865a10dffb6a26e4a9` and an exact-head 1,238,037-byte sdist at `b04518bab12b29d148eab9d6a76178c99320300472adfad38cdbd9cdd0c98b89`. |
| Two separated integration review audits | Clean | Both exact-head audits found zero issue comments, reviews, inline comments, and review threads. PR #169 remained ready, clean, mergeable, and at `f4131213e2221e7316414448331decc09a6a2900`. |
| Integration squash verification | 0 | PR #169 squash `aaa2d762bc55681a5cada448ae6ec148413370de` has exact reviewed tree `d5533287cdc618391afb15d5ebeb73b2c109becb`, sole parent feature squash `65a1e90901964f40f3ef9ace63d7700f0fccd796`, exact DCO, and GitHub-valid signature verified at `2026-08-12T17:18:48Z`. The remote integration branch was deleted; the verified obsolete local branch was then deleted. |
| Closeout local qualification | 0 | Exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, and `.project/TEST_EVIDENCE.md` changed. All 789 architecture assertions passed with 1 local capability skip in 5.05 seconds; strict docs built in 1.33 seconds with only the known upstream notice; whitespace and full Git-object checking passed. The diff contains no credential/private-key or explicit development-tool identity marker and changes no workflow, runtime, verifier, producer, dependency, package, test, public documentation, or roadmap surface. |
...
| Exact published feature head | DCO | Commit `fd124202e95288f305fd57a74c918550c8104804`, tree `e144b20a8ec372defd7766c9d81dd943342f6adf`, has sole parent M70 closeout and exact `Signed-off-by: Louijie Compo <louijie.compo@gmail.com>`. PR #165 was ready against `main` and exact-head run `31616197801` classified it substantive. |
| Hosted Linux qualification | 0 | Job `94179498942` passed in 7m21s. CPython 3.12 passed 2,325 tests; CPython 3.13 and 3.14 each passed 2,325 with 1 expected skip. Formatting, Ruff, strict Pyright/docs, 10 real-wgpu tests, both profiles, both vertical slices, reproducible build, wheel smoke, staging, and complete release smoke passed. |
| Hosted macOS qualification | 0 | Job `94181563942` passed in 3m10s. Ten real-wgpu tests, the three-workload graphics profile, Clockwork Arena, Agent World Builder, and CPython 3.14 with 2,325 passes and 1 expected skip all passed. |
| Hosted Windows qualification | 0 | Job `94181564071` passed in 4m12s. Ten real-wgpu tests, the three-workload graphics profile, Clockwork Arena, Agent World Builder, and CPython 3.14 with 2,325 passes and 1 expected skip all passed. |
| Hosted artifact identity | 0 | Two exact-head builds reproduced a pure 273,509-byte wheel at `06c2501eb5fcc999ff2d59716bd47bc5ecafb0a25473d485d314327a57867e82` and a 1,227,996-byte sdist at `50dc7061ace2bbf1a4947246062aa355594cd95fbff44c250fe10ff8e15be678`; installed-wheel, staging, and complete release smoke passed. |
| Two separated GitHub review audits | Clean | Both exact-head audits found zero issue comments, reviews, inline comments, and review threads. PR #165 remained ready, clean, mergeable, and at `fd124202e95288f305fd57a74c918550c8104804`. |
| Feature squash verification | 0 | PR #165 squash `a408198b2a3ce9e59d50372095dde2afb6ac9fe5` has exact reviewed tree `e144b20a8ec372defd7766c9d81dd943342f6adf`, sole parent M70 closeout, exact DCO, and GitHub-valid signature verified at `2026-08-12T16:23:48Z`. The remote feature branch was deleted; the verified obsolete local feature branch was then deleted. |
| Integration-record lock/static/architecture/docs/Git-object gate | 0 | The exact four paths are `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, `.project/TEST_EVIDENCE.md`, and `ROADMAP.md`. The unchanged lock resolved 46 packages in 0.92 ms; all 314 files were format clean; Ruff and strict Pyright reported zero findings; all 780 architecture assertions passed with 1 local capability skip in 5.59 seconds; strict docs built in 1.28 seconds with only the known upstream notice; whitespace passed; full Git-object checking reported only pre-existing unreachable objects and exited zero. |
| Integration-record reproducibility and release gate | 0 | Two builds reproduced the feature-identical pure 273,524-byte wheel at `791f2c909cf9b89381443f0b89d6baa79ed56f7a0bd96fa7de4d09521f597671` and a 1,229,599-byte record-updated sdist at `88e50fabed0299caa603166043967123997b8ecb686d10c3953fd2fc3cca24d7`. Installed-wheel smoke, deterministic ten-artifact staging, and complete release smoke passed. |
| Hosted integration-record qualification | 0 | Exact DCO head `f4bb6ef2fac3d4e8d58203c7028aee0f9aa5a73a`, tree `ac55309b8a9a31a4706849f5954504e5292f81bf`, passed run `31617678812` in one 44-second Linux allocation; the desktop umbrella job `94184671781` skipped with zero steps. Job `94184460029` classified exactly four changed paths as documentation, found all 314 files format clean, passed Ruff and strict docs in 1.66 seconds, passed 781 architecture assertions in 9.50 seconds, reproduced artifacts, and passed wheel/staging/release smoke. |
| Hosted integration artifact identity | 0 | Two exact-head builds reproduced the feature-identical pure 273,509-byte wheel at `06c2501eb5fcc999ff2d59716bd47bc5ecafb0a25473d485d314327a57867e82` and an exact-head 1,229,985-byte sdist at `5b7a5d3d1de4de06ea83a4274c8d67fe449d7c0b24c665919acd5a2e1d348d8a`. |
| Two separated integration review audits | Clean | Both exact-head audits found zero issue comments, reviews, inline comments, and review threads. PR #166 remained ready, clean, mergeable, and at `f4bb6ef2fac3d4e8d58203c7028aee0f9aa5a73a`. |
| Integration squash verification | 0 | PR #166 squash `9ce08e520c97ddb06de446718fbdc8ada90060ad` has exact reviewed tree `ac55309b8a9a31a4706849f5954504e5292f81bf`, sole parent feature squash `a408198b2a3ce9e59d50372095dde2afb6ac9fe5`, exact DCO, and GitHub-valid signature verified at `2026-08-12T16:30:25Z`. The remote integration branch was deleted; the verified obsolete local branch was then deleted. |
| Closeout local qualification | 0 | Exactly `.project/CURRENT_TASK.md`, `.project/PROJECT_STATE.md`, and `.project/TEST_EVIDENCE.md` changed. All 780 architecture assertions passed with 1 local capability skip in 5.66 seconds; strict docs built in 1.17 seconds with only the known upstream notice; whitespace and full Git-object checking passed. The diff contains no credential/private-key or explicit development-tool identity marker and changes no workflow, runtime, verifier, producer, dependency, package, test, public documentation, or roadmap surface. |
