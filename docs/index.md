...
M36-M38 reduce hosted-runner waste, qualify documentation changes from a
trusted base, and enforce same-source distribution byte reproducibility without
weakening substantive validation.
