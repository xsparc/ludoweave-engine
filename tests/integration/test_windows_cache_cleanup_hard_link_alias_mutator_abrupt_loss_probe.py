"""Test-only Windows hard-link alias mutator abrupt-loss probe."""
...
pytestmark = pytest.mark.skipif(
    sys.platform != "win32",
    reason="M187 probes abrupt loss of a Windows hard-link alias mutator",
)

_ERROR_SHARING_VIOLATION = 32


def test_abrupt_mutator_loss_after_delete_leaves_alias_absent(
    tmp_path: Path,
) -> None:
    ...
    try:
        ...
        with identity_probe:
            ...
            assert identity_probe.link_count(displaced) == 1
