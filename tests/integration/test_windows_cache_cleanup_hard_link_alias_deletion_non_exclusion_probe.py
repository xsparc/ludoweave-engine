"""Test-only Windows hard-link alias deletion probe."""
...
pytestmark = pytest.mark.skipif(
    sys.platform != "win32",
    reason="M184 probes Windows hard-link alias deletion",
)

_ERROR_SHARING_VIOLATION = 32


def test_matching_guardian_does_not_exclude_hard_link_alias_deletion(tmp_path: Path) -> None:
