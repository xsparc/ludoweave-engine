"""Test-only Windows alias-mutator invalid-prefix close-suffix probe."""
...
pytestmark = pytest.mark.skipif(
    sys.platform != "win32",
    reason="M192 probes an invalid prefix before a valid close suffix after recreation",
)
...
def _send_invalid_prefix_with_valid_close_suffix_and_assert_settlement(
...
def test_invalid_prefix_precedes_valid_close_suffix_after_recreate(
    tmp_path: Path,
) -> None:
