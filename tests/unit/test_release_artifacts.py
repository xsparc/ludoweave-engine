...
def test_release_stage_is_reproducible_and_complete(tmp_path: Path) -> None:
    ...
    assert prefix + "agent_tool_recovery_rate_readiness.py" in names
    ...
    assert prefix + "external_contributor_retention_readiness.py" in names
    ...
    assert prefix + "installation_matrix_readiness.py" in names
    ...
    assert prefix + "assets/agent_tool_recovery_rate.json" in names
    ...
    assert prefix + "assets/installation_matrix.json" in names
